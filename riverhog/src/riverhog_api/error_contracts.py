...
RIVERHOG_OPERATION_ERROR_CODES: Mapping[str, frozenset[str]] = {
    ...
    "list_collection_tags": frozenset({"conflict", "not_found"}),
    "collection_contains_tag": frozenset({"conflict", "not_found"}),
    "add_collection_tag": frozenset({"conflict", "not_found", "precondition_failed"}),
    "remove_collection_tag": frozenset({"conflict", "not_found", "precondition_failed"}),
