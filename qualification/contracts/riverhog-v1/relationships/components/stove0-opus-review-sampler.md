...
| Source path | `reference/stove0/targets/opus/review-sampler` |
| Description source | `reference/stove0/targets/opus/review-sampler/pyproject.toml#/project/description` |
| Owned contract elements | 1 |

[Open exact owned authority](../../authorities/stove0-opus-review-sampler/index.md)
...
| outgoing | `packaged-in` | `stove0-opus-target` | `` |
