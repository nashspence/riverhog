...
| Source path | `reference/riverhog/storage/backblaze` |
| Description source | `reference/riverhog/storage/backblaze/pyproject.toml#/project/description` |
| Owned contract elements | 1 |

[Open exact owned authority](../../authorities/riverhog-storage-adapter-backblaze/index.md)
