...
- [Riverhog-owned contracts and libraries](surfaces/riverhog.md#riverhog-owned-contracts-and-libraries) — 13 authorities, 80 contract elements
  ...
  - [riverhog-client](authorities/riverhog-client/index.md) — 15 contract elements
  ...
  - [riverhog-storage-adapter-support](authorities/riverhog-storage-adapter-support/index.md) — 28 contract elements
...
- [Implementation and build](surfaces/riverhog.md#implementation-and-build) — 5 authorities, 56 contract elements
...
- [Riverhog references](surfaces/references.md#riverhog-references) — 14 authorities, 68 contract elements
  - [riverhog-ftp-adapter](authorities/riverhog-ftp-adapter/index.md) — 29 contract elements
  ...
  - [riverhog-storage-adapter-filesystem](authorities/riverhog-storage-adapter-filesystem/index.md) — 2 contract elements
  - [riverhog-storage-adapter-s3-support](authorities/riverhog-storage-adapter-s3-support/index.md) — 1 contract element
- [Gogurt](surfaces/references.md#gogurt) — 11 authorities, 39 contract elements
  - [gogurt](authorities/gogurt/index.md) — 24 contract elements
  - [gogurt-core](authorities/gogurt-core/index.md) — 4 contract elements
...
- [Piggity](surfaces/references.md#piggity) — 2 authorities, 95 contract elements
  - [piggity](authorities/piggity/index.md) — 94 contract elements
  - [piggity-local](authorities/piggity-local/index.md) — 1 contract element
- [Stove0](surfaces/stove0.md) — 33 authorities, 366 contract elements
  - [Application](surfaces/stove0.md#application) — 7 authorities, 274 contract elements
    - [stove0](authorities/stove0/index.md) — 203 contract elements
    - [stove0-api-client](authorities/stove0-api-client/index.md) — 7 contract elements
    - [stove0-client](authorities/stove0-client/index.md) — 38 contract elements
    ...
    - [stove0-server](authorities/stove0-server/index.md) — 21 contract elements
  - [Observers](surfaces/stove0.md#observers) — 7 authorities, 38 contract elements
    ...
    - [stove0-observer-support](authorities/stove0-observer-support/index.md) — 12 contract elements
  - [Targets](surfaces/stove0.md#targets) — 8 authorities, 27 contract elements
    ...
    - [stove0-nvenc-av1-opus-target](authorities/stove0-nvenc-av1-opus-target/index.md) — 3 contract elements
    - [stove0-opus-target](authorities/stove0-opus-target/index.md) — 2 contract elements
    ...
    - [stove0-target-support](authorities/stove0-target-support/index.md) — 14 contract elements
  - [Review](surfaces/stove0.md#review) — 10 authorities, 24 contract elements
    - [stove0-nvenc-av1-opus-review-sampler](authorities/stove0-nvenc-av1-opus-review-sampler/index.md) — 2 contract elements
    - [stove0-opus-review-sampler](authorities/stove0-opus-review-sampler/index.md) — 2 contract elements
    ...
    - [stove0-review-target-support](authorities/stove0-review-target-support/index.md) — 3 contract elements
  - [Recipes](surfaces/stove0.md#recipes) — 1 authority, 3 contract elements
    - [stove0-recipe-config](authorities/stove0-recipe-config/index.md) — 3 contract elements
...
- [repository](authorities/repository/index.md) — 4 contract elements
