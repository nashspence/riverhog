...
| [stove0-observer-protocol](../authorities/stove0-observer-protocol/index.md) | 81 | Python | Dependency-light public contracts for external stove0 content observers. |
...
| [stove0-target-support](../authorities/stove0-target-support/index.md) | 169 | Process Protocol, Process Protocol Operations, Process Protocol Schemas, CLI, Configuration Environment, Python | Hardware-neutral target protocol, runtime, and conformance support for stove0. |
...
| [stove0-review-target-contracts](../authorities/stove0-review-target-contracts/index.md) | 26 | Python | Optional nonnormative review contract reference for Stove0 targets. |
| [stove0-review-target-support](../authorities/stove0-review-target-support/index.md) | 21 | Configuration Documents, Python | Optional nonnormative shared review-target support reference for Stove0. |

## Recipes

Authorities: **1** · Contract elements: **31**

| Exact authority | Contract elements | Interfaces | Maintained purpose |
|---|---:|---|---|
| [stove0-recipe-config](../authorities/stove0-recipe-config/index.md) | 31 | Configuration Documents, Python | Portable deployment-owned Stove0 recipe catalog contracts and validation. |
