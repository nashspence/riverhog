...
- [tests/unit/test\_catalog\_sync.py::test\_catalog\_sync\_crosses\_many\_pages\_and\_repairs\_fixed\_frontier\_changes](../../../../../../tests/unit/test_catalog_sync.py#L237) — Catalog-sync fixed-frontier traversal and repair; ordinary mutable collection browsing has different semantics and gains no snapshot-completeness claim.
