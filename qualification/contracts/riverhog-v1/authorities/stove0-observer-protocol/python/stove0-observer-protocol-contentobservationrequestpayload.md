...
| <a id="s-35a7a28c41"></a>`subjects` | yes | type="array"; items=([WorkArtifactSubject](#s-ef460d1022)); minItems=1 |  |
...
- [CollectionRootIdentityRef](#s-ac3b6741f2)
- [JsonValue](#s-31e73432cf)
- [NonnegativeDecimal](#s-358a3b8161)
- [WorkArtifactSubject](#s-ef460d1022)
...
##### <a id="s-ac3b6741f2"></a>definition `CollectionRootIdentityRef`

- <a id="s-6844c53c19"></a>`type`: `"object"`
- <a id="s-13fa89802c"></a>`additionalProperties`: `false`
- <a id="s-3846941db2"></a>`required`: `["collection_id","archive_root_sha256","content_identity"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-e2e3b97de7"></a>`archive_root_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-5de9a5dc2e"></a>`collection_id` | yes | [CollectionId](#s-d0419883ec) |  |
| <a id="s-a01cbd3184"></a>`content_identity` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |

##### <a id="s-31e73432cf"></a>definition `JsonValue`

- Accepts: any JSON value.

##### <a id="s-358a3b8161"></a>definition `NonnegativeDecimal`

- <a id="s-8cd676c6f5"></a>`type`: `"string"`
- <a id="s-691b40a6b4"></a>`pattern`: `"^(?:0\|[1-9][0-9]*)(?![\\s\\S])"`

##### <a id="s-ef460d1022"></a>definition `WorkArtifactSubject`

- <a id="s-c96aedc029"></a>`type`: `"object"`
- <a id="s-f893155215"></a>`additionalProperties`: `false`
- <a id="s-ded1122c77"></a>`required`: `["id","role","collection","path","bytes","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-904df06851"></a>`bytes` | yes | [NonnegativeDecimal](#s-358a3b8161); ge=0 |  |
| <a id="s-5e76c78681"></a>`collection` | yes | [CollectionRootIdentityRef](#s-ac3b6741f2) |  |
| <a id="s-20edc48011"></a>`id` | yes | type="string"; pattern="^[A-Za-z0-9]&#40;?:[A-Za-z0-9._-]{0,158}[A-Za-z0-9])?$" |  |
| <a id="s-818d1c9528"></a>`media_type` | no | anyOf=[(type="string"; maxLength=255; minLength=1); (type="null")]; default=null |  |
| <a id="s-688c58957d"></a>`path` | yes | type="string"; maxLength=4096; minLength=1 |  |
| <a id="s-ee9adf4d95"></a>`role` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-d2b5baa6ec"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
<!-- exact-contract-value: f169a89e5b8fc7e85ea5b181c0c4673bb57b7e7de18b48a2f9c390aca23f3250 -->
