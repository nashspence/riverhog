...
|---|---:|---|---|
| <a id="s-5028d5595d"></a>`facts_schema` | yes | [JsonSchemaValidationProfile](#s-944f57bc2c) |  |
...
| <a id="s-978ada5c0c"></a>`options_schema` | yes | [JsonSchemaValidationProfile](#s-944f57bc2c) |  |

##### Definitions

- [JsonSchemaValidationProfile](#s-944f57bc2c)
- [JsonValue](#s-bd2e069bd0)
- [SemanticValidationProfile](#s-c9658308bd)

##### <a id="s-944f57bc2c"></a>definition `JsonSchemaValidationProfile`

- <a id="s-670c42721d"></a>`type`: `"object"`
- <a id="s-e5bc877617"></a>`additionalProperties`: `false`
- <a id="s-bfee0122b6"></a>`required`: `["id","profile_sha256","schema"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-a9cf6db6b5"></a>`dialect` | no | type="string"; const="https://json-schema.org/draft/2020-12/schema"; default="https://json-schema.org/draft/2020-12/schema" |  |
| <a id="s-afad1b425b"></a>`format_policy` | no | type="string"; const="annotation-only"; default="annotation-only" |  |
| <a id="s-4b4c88ec74"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-2c0e4ede52"></a>`profile_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-9c13b682d1"></a>`schema` | yes | type="object"; additionalProperties=([JsonValue](#s-bd2e069bd0)) |  |
...
<!-- exact-contract-value: 7b2b92e4c0d7772db09d5bfe3ba425651128ba61bcb816504233b2505f8b766e -->
