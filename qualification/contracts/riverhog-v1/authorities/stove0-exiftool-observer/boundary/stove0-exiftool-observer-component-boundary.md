...
| Field | Shape |
|---|---|
| `console_scripts` | additional keys=`stove0-exiftool-observer` |
| `dependencies` | ["http-api-contracts","stove0-media-metadata-observer-contracts","stove0-observer-protocol","stove0-observer-support"] |
