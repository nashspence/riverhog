...
- <a id="pa-a561f1f879"></a>[compatibility/configuration/v1](../../../policies/index.md#p-8dc08bb461)
...
- [configuration-environment:stove0-review-rclone-effect-target:STOVE0_REVIEW_RCLONE_EFFECT_TARGET_SAMPLERS_JSON](../../../evidence/sources.md#src-442d08ddb7) — `reference/stove0/targets/review/rclone-effect-target/src/stove0_review_rclone_effect_target/app.py`
...
|---|---|---|---|
| parser | `stove0-review-rclone-effect-target` | `reference/stove0/targets/review/rclone-effect-target/src/stove0_review_rclone_effect_target/app.py` | `os.getenv(f'{PREFIX}_SAMPLERS_JSON')` |
