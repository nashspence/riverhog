...
- <a id="s-e0f075ed43"></a>`kind`: `"constant"`
- <a id="s-81274cebf7"></a>`value`: `"stove0.media.metadata-options/v1"`

## Governing policies

- <a id="pa-9053edf2b9"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
