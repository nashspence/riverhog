...
- <a id="s-30c31f27b3"></a>`kind`: `"constant"`
- <a id="s-085f6e941a"></a>`value`: `"stove0.media.metadata/v1"`

## Governing policies

- <a id="pa-8a5ff372c1"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
