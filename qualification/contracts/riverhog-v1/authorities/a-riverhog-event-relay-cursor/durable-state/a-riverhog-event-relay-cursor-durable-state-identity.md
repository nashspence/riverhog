# a-riverhog-event-relay-cursor durable-state identity

[Atlas](../../../index.md) · [Authority](../index.md) · [Interface](index.md) · [Policies](../../../policies/index.md)

<!-- contract-element: durable-state:a-riverhog-event-relay-cursor:a-riverhog-event-relay-cursor-durable-state-identity:1d47d3a8eb -->
...
|---|---|
| <a id="s-9bc86493fe"></a>`distribution` | `"a-riverhog-event-relay"` |
| <a id="s-0773785869"></a>`format` | `"state-schema/sqlite"` |
| <a id="s-13db1ae0f6"></a>`head` | `"v1_0001"` |
| <a id="s-af7d97db3b"></a>`id` | `"a-riverhog-event-relay-cursor"` |
...
- [source_cursors](a-riverhog-event-relay-cursor-source-cursors.md)

## Governing policies

- <a id="pa-7227fa240d"></a>[compatibility/durable-state/v1](../../release/compatibility-guarantees/compatibility-durable-state.md#p-214a49c2de)
...
<!-- exact-contract-value: a634bf80ec92cd2d46946ff946588850e220dfbddb8f61e0a4e036e68dfe7bf6 -->
