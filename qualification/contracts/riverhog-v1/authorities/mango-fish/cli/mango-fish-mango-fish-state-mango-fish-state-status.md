...
- <a id="s-23c16a212988"></a>Parser name: `mango-fish state status`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-f1aea638f432"></a>`` | _StoreTrueAction | no |  | --json |
...
|---|---|---|
| [CLI parameter --json](#s-f1aea638f432) | `cardinality · values-per-occurrence · fixed` | shared above |

## Governing policies

- <a id="pa-411afeb2a0e5"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-4bcd971c29d3"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
