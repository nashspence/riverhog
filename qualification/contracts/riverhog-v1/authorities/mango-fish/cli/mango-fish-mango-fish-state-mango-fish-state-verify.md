...
- <a id="s-9527b6167f"></a>Parser name: `mango-fish state verify`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-7505345121"></a>`` | _StoreTrueAction | no |  | --json |
...
- <a id="pa-dbc8c12994"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de)
- <a id="pa-444a439ae6"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
