...
- <a id="s-6c042627e8"></a>`additionalProperties`: `false`
- <a id="s-4931544eb3"></a>`required`: `["id","rules"]`

##### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-f76a0e9f37"></a>`conformance_vectors_sha256` | no | anyOf=[(type="string"; pattern="^[0-9a-f]{64}$"); (type="null")]; default=null |  |
| <a id="s-937e0186cb"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-9ee0cdfb0b"></a>`rules` | yes | type="array"; items=(type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$"); minItems=1 |  |
...
- <a id="pa-e3e7911854"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
