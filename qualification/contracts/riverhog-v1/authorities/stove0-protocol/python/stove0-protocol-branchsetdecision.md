...
<a id="s-78870634c9"></a>
- <a id="s-e1d08b1703"></a>`title`: BranchSetDecision
- <a id="s-3cc372e6f0"></a>`description`: A sealed branch-set plan plus its separately addressable selections.
...
<!-- exact-contract-value: c6bff97319d22cfae68a9eeba6b4e7485c1c35d16f65d1b3ab718129f8d1e532 -->
...
```json
{
  "contract": {
    ...
    "schema": {
      ...
      "additionalProperties": false,
      "description": "A sealed branch-set plan plus its separately addressable selections.",
      "properties": {
        "branch_sets": {
          "default": [],
          "items": {
