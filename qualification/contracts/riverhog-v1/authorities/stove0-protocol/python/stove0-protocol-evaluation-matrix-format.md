...
- <a id="s-a7cae12cdf"></a>`kind`: `"constant"`
- <a id="s-c1bcd186f6"></a>`value`: `"stove0-evaluation-matrix/v1"`

## Governing policies

- <a id="pa-df539d6c65"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
