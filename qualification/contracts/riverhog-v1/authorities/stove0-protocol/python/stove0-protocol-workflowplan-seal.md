...
- <a id="s-9b42cb7d63"></a>`kind`: `"classmethod"`
- <a id="s-d754483fbc"></a>`signature`: `"\"(cls, payload: 'WorkflowPlanPayload') -> 'WorkflowPlan'\""`
...
- <a id="pa-042acc72e1"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
