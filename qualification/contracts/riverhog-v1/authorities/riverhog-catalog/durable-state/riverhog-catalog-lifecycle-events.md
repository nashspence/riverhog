...
| <a id="s-2e0b94d2ef"></a>`owner_principal_id` | `VARCHAR` | no | `—` | — |
...
- <a id="pa-b20e6d1eba"></a>[compatibility/durable-state/v1](../../release/compatibility-guarantees/compatibility-durable-state.md#p-214a49c2de)
