...
| <a id="s-06a2164c54"></a>`principal_id` | `VARCHAR` | no | `—` | — |
...
- <a id="pa-2dba426323"></a>[compatibility/durable-state/v1](../../release/compatibility-guarantees/compatibility-durable-state.md#p-214a49c2de)
