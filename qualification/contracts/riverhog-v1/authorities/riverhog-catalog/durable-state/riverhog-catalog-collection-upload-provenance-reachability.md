...
<!-- contract-element: durable-state:riverhog-catalog:riverhog-catalog-collection-upload-proven-4d44f80a4c:5505041547 -->
...
| <a id="s-af281d0fd2"></a>`after_external_fact_key` | `VARCHAR` | yes | `—` | — |
...
|---|---|---|
| <a id="s-ec22ab1087"></a>`primary-key` | `—` | `PRIMARY KEY (collection_id, journal_id)` |
...
- <a id="pa-021763ed91"></a>[compatibility/durable-state/v1](../../release/compatibility-guarantees/compatibility-durable-state.md#p-214a49c2de)
