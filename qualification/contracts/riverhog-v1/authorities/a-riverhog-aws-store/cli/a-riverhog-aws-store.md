...
|---|---|---|
| [CLI parameter --host](#s-375b606e4b) | `cardinality · values-per-occurrence · fixed` | shared above |
| [CLI parameter --port](#s-c69eac7cfd) | `cardinality · values-per-occurrence · fixed` | shared above |
