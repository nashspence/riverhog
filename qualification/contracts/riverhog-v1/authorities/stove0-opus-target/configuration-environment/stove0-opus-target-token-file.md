...
- <a id="pa-eef39f6783"></a>[compatibility/configuration/v1](../../release/compatibility-guarantees/compatibility-configuration.md#p-8dc08bb461)
...
- [configuration-environment:stove0-opus-target:STOVE0_OPUS_TARGET_TOKEN_FILE](../../../evidence/sources/authorities.md#src-0d6bd47b40) — [reference/stove0/targets/opus/target/src/stove0\_opus\_target/app.py::\_secret](../../../../../../reference/stove0/targets/opus/target/src/stove0_opus_target/app.py)
...
|---|---|---|---|
| parser | `stove0-opus-target` | [reference/stove0/targets/opus/target/src/stove0\_opus\_target/app.py](../../../../../../reference/stove0/targets/opus/target/src/stove0_opus_target/app.py) | `os.getenv(f'{prefix}_TOKEN_FILE')` |
