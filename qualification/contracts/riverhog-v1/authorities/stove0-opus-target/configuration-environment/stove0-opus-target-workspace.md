...
- <a id="pa-637648f2ab"></a>[compatibility/configuration/v1](../../release/compatibility-guarantees/compatibility-configuration.md#p-8dc08bb461)
...
- [configuration-environment:stove0-opus-target:STOVE0_OPUS_TARGET_WORKSPACE](../../../evidence/sources/authorities.md#src-d621aac3e2) — [reference/stove0/targets/opus/target/src/stove0\_opus\_target/app.py::target\_main](../../../../../../reference/stove0/targets/opus/target/src/stove0_opus_target/app.py)
...
|---|---|---|---|
| parser | `stove0-opus-target` | [reference/stove0/targets/opus/target/src/stove0\_opus\_target/app.py](../../../../../../reference/stove0/targets/opus/target/src/stove0_opus_target/app.py) | `os.getenv(f'{prefix}_WORKSPACE', '/run/stove0-opus-target')` |
