...
- [configuration-environment:stove0-opus-target:STOVE0_OPUS_TARGET_HOST](../../../evidence/sources.md#src-8aa1fc04d2) — `reference/stove0/targets/opus/target/src/stove0_opus_target/app.py`
...
|---|---|---|---|
| parser | `stove0-opus-target` | `reference/stove0/targets/opus/target/src/stove0_opus_target/app.py` | `os.getenv(f'{prefix}_HOST', '127.0.0.1')` |
