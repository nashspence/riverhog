...
- <a id="pa-596517e553"></a>[compatibility/configuration/v1](../../release/compatibility-guarantees/compatibility-configuration.md#p-8dc08bb461)
...
- [configuration-environment:stove0-opus-target:STOVE0_OPUS_TARGET_STATE_ROOT](../../../evidence/sources/authorities.md#src-ba7aa199b0) — [reference/stove0/targets/opus/target/src/stove0\_opus\_target/app.py::target\_main](../../../../../../reference/stove0/targets/opus/target/src/stove0_opus_target/app.py)
...
|---|---|---|---|
| parser | `stove0-opus-target` | [reference/stove0/targets/opus/target/src/stove0\_opus\_target/app.py](../../../../../../reference/stove0/targets/opus/target/src/stove0_opus_target/app.py) | `os.getenv(f'{prefix}_STATE_ROOT', '/var/lib/stove0-opus-target')` |
