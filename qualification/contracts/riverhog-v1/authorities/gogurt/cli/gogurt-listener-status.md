...
| <a id="s-2e525796ff"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
...
- <a id="pa-af73aedac4"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de)
- <a id="pa-ad83f8541a"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
