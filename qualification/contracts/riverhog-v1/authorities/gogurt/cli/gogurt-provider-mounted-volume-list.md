...
|---|---|---|---|
| <a id="s-39f1dc9eb2"></a>`ids`<br>`--ids` | optional flag; 0 values | boolean | `false` |
| <a id="s-20a1505b65"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
...
|---|---|---|---|---|
| <a id="s-cf8f2c4504"></a>`completed` | <a id="s-50f315949d"></a>`{"kind":"command-completed"}` | <a id="s-cc1b9f9be2"></a>`0` | <a id="s-6425bca83c"></a>human: `noncontractual-presentation-of-command-result`; json: [gogurt-provider-list/v1](#s-6425bca83c) | <a id="s-536936b94e"></a>all: `empty` |
...
| <a id="s-ccfca921f6"></a>`operational` | <a id="s-72e98de6a5"></a>`{"kind":"application-error"}` | <a id="s-ec8d487fe3"></a>`1` | <a id="s-1c58824587"></a>human: `empty`; json: [gogurt-cli-error/v1](#s-1c58824587) | <a id="s-71a4576897"></a>human: `noncontractual-diagnostic`; json: `empty` |
