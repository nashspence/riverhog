...
|---|---|---|---|
| <a id="s-ae67412ef1"></a>`name`<br>`name` | required positional; 1 value | text | not recorded |
| <a id="s-acb58db353"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
...
- <a id="pa-062d4a3408"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de)
- <a id="pa-378d69a325"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
