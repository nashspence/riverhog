...
- <a id="s-c09cd63ef8"></a>`signature`: `"\"(self, claim_id: 'ProcessingClaimId', *, identity_sha256: 'str', start_ordinal: 'int' = 0) -> 'CollectionArtifactPageDocument'\""`
...
- <a id="pa-d4e9fd043f"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
...
- **Client method:** [packages/riverhog-client/src/riverhog\_client/workflows.py::CollectionWorkflowMethods.list\_processing\_claim\_artifacts](../../../../../../packages/riverhog-client/src/riverhog_client/workflows.py#L380)
...
<!-- exact-contract-value: cbdc2b25ff070a7e09be65bc34b2229fc4ff2d80988bb2aca0435265703a3b28 -->

```json
{
  "contract": {
    "kind": "method",
    "signature": "\"(self, claim_id: 'ProcessingClaimId', *, identity_sha256: 'str', start_ordinal: 'int' = 0) -> 'CollectionArtifactPageDocument'\""
  },
