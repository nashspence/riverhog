...
- <a id="s-261d7ea8ce"></a>`kind`: `"method"`
- <a id="s-276cd579c2"></a>`signature`: `"\"(self, client: 'Any', *, owns_client: 'bool' = True) -> 'None'\""`
...
- <a id="pa-1d1ab5de46"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
