...
Python contract owned by riverhog-storage-adapter-s3-support.

## Semantic dossiers

### `riverhog_storage_adapter_s3_support`

- [riverhog_storage_adapter_s3_support.S3ClientConfig](riverhog-storage-adapter-s3-support-s3clientconfig.md)
...
- [riverhog_storage_adapter_s3_support.S3StorageAdapterConfig](riverhog-storage-adapter-s3-support-s3storageadapterconfig.md)
- [riverhog_storage_adapter_s3_support.S3TransportTuning](riverhog-storage-adapter-s3-support-s3transporttuning.md)
- [riverhog_storage_adapter_s3_support.create_s3_client](riverhog-storage-adapter-s3-support-create-s3-client.md)
