...
<!-- contract-element: http-schemas:stove0:schemas-outputartifact:04b80310ca -->
...
- <a id="s-59e8eb5ea3"></a>`additionalProperties`: `false`
- <a id="s-1ef2cb3a3b"></a>`required`: `["id","role","path","bytes","sha256"]`
...
| <a id="s-ab3a2479f9"></a>`media_type` | no | anyOf=(type="string"; maxLength=255; minLength=1) \| (type="null") |  |
| <a id="s-da4738004d"></a>`path` | yes | type="string"; maxLength=4096; minLength=1 |  |
...
- <a id="pa-3b1ded151e"></a>[compatibility/http-api/v1](../../../policies/index.md#p-5bc717c2c0)
- <a id="pa-7d3e2d46d5"></a>[extent-rule/no-semantic-maximum/v1](../../../policies/index.md#p-574724b48a)
- <a id="pa-fb46a0a383"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
