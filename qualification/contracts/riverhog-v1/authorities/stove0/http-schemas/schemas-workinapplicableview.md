...
<!-- contract-element: http-schemas:stove0:schemas-workinapplicableview:b2c3538f9c -->
...
|---|---:|---|---|
| <a id="s-a3ff8d188d"></a>`code` | yes | type="string"; maxLength=160; minLength=1; title="Code" |  |
| <a id="s-3e3aa8cd68"></a>`message` | yes | type="string"; maxLength=1000; minLength=1; title="Message" |  |
...
- <a id="pa-d7cb79acfe"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
- <a id="pa-6344ad2c41"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
