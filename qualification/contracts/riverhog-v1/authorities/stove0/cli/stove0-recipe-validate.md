...
- <a id="s-c2446b375bd7"></a>Parser name: `validate`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-b8713f606785"></a>`path` | TyperArgument | yes | {'class': 'typer.models.TyperPath', 'name': 'file'} | path |
...
|---|---|---|
| [CLI parameter path](#s-b8713f606785) | `cardinality · values-per-occurrence · fixed` | shared above |

## Governing policies

- <a id="pa-cbcc483c35dc"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-e911369b6824"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
