...
- <a id="s-dd0f6f8ecbed"></a>Parser name: `health`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-0148aceb4580"></a>`ready` | TyperOption | no | {'class': 'typer._click.types.BoolParamType', 'name': 'boolean'} | --ready |
...
|---|---|---|
| [CLI parameter --ready](#s-0148aceb4580) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-4e3e86c757c5"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-096d7662a2fe"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
