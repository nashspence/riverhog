...
- <a id="s-bd474dd5e9e7"></a>Parser name: `cancel`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-a6b26b3e5897"></a>`evaluation_id` | TyperArgument | yes | {'class': 'typer._click.types.StringParamType', 'name': 'text'} | evaluation_id |
...
|---|---|---|
| [CLI parameter evaluation_id](#s-a6b26b3e5897) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-ceac47307b55"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-09f6cc6c1a0c"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
