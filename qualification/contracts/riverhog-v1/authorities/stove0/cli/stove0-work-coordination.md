...
- <a id="s-d9173713419b"></a>Parser name: `coordination`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-8b4c2e9366d6"></a>`work_id` | TyperArgument | yes | {'class': 'typer._click.types.StringParamType', 'name': 'text'} | work_id |
...
|---|---|---|
| [CLI parameter work_id](#s-8b4c2e9366d6) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-08f1688264ad"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-dc3dbb40b251"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
