...
- <a id="s-0639b8f0498d"></a>Parser name: `create`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-64aae090919a"></a>`definition` | TyperArgument | yes | {'class': 'typer.models.TyperPath', 'name': 'path'} | definition |
...
|---|---|---|
| [CLI parameter definition](#s-64aae090919a) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-fc9cd8d812c6"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-93492abe9371"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
