...
| <a id="s-f866888f93"></a>`400` | Bad Request | application/json | [ErrorOut](../http-schemas/schemas-errorout.md) | `bad_request` |
| <a id="s-b20246c2a8"></a>`401` | Unauthorized | application/json | [ErrorOut](../http-schemas/schemas-errorout.md) | `unauthorized` |
| <a id="s-2d228313df"></a>`403` | Forbidden | application/json | [ErrorOut](../http-schemas/schemas-errorout.md) | `forbidden` |
| <a id="s-cd90dda77d"></a>`500` | Internal Server Error | application/json | [ErrorOut](../http-schemas/schemas-errorout.md) | `internal_error` |
...
- [stove0 work list](../../a-stove0-cli/cli/stove0-work-list.md)
...
- <a id="pa-0412e88915"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
- <a id="pa-0650c319ca"></a>[extent-rule/route-progression/v1](../../extent-contract/extent/extent-rule-route-progression.md#p-6b76b527cb)
- <a id="pa-112321b18b"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
- **Handler:** [some-implementations/stove0/application/server/src/stove0\_api/app.py::create\_app.&lt;locals&gt;.list\_work](../../../../../../some-implementations/stove0/application/server/src/stove0_api/app.py#L659)
  ...
  "cli_bindings": [
    {
      "command": "work list",
      "executable": "stove0",
      "result_identity": "stove0-cli-result/work/list/v1",
      "source": {
        "line": 267,
...
<!-- exact-contract-value: 029d002ab72bd806cdd621045ca46af983f38f46361997a9f8e0eafc30804c71 -->
