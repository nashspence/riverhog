...
<a id="s-8c50ecf7183b"></a>
- <a id="s-fd9b2cc2f1f7"></a>`operationId`: cancel_evaluation
- <a id="s-6dd46bc3f2d4"></a>`summary`: Cancel Evaluation

### Parameters

| Name | In | Required | Schema |
|---|---|---:|---|
| <a id="s-5863030673f1"></a>`evaluation_id` | path | yes | type="string" |

### Responses

| Status | Description |
|---|---|
| <a id="s-26caea921ff9"></a>`200` | Successful Response |
| <a id="s-5540b6256d12"></a>`400` | Bad Request |
| <a id="s-175c74d4329d"></a>`401` | Unauthorized |
| <a id="s-ad4ed29f8cc2"></a>`403` | Forbidden |
| <a id="s-34fbffc57d83"></a>`404` | Not Found |
| <a id="s-19f6481c957c"></a>`409` | Conflict |
| <a id="s-a98b75a7eea7"></a>`500` | Internal Server Error |
...
- <a id="pa-cb9b17fe0483"></a>[compatibility/http-api/v1](../../../policies/index.md#p-5bc717c2c0ba)
