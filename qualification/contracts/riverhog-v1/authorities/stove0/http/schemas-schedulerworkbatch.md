...
|---|---:|---|---|
| `cursor` | yes | type="string" |  |
| `failures` | yes | type="array"; items=(#/components/schemas/SchedulerFailure) |  |
| `next_cursor` | yes | type="string" |  |
| `progressed` | yes | type="array"; items=(type="string"; pattern="^[0-9a-f]{64}$") |  |
| `role` | yes | type="string"; enum=["controller","worker","combined"] |  |
