...
| `branches` | yes | type="array"; minItems=1; items=(oneOf=#/components/schemas/BranchPlan \| #/components/schemas/CoordinationBranchPlan; additional keys=`discriminator`) |  |
| `decision_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| `evidence_sha256s` | no | type="array"; items=(type="string"; pattern="^[0-9a-f]{64}$") |  |
| `format` | no | type="string"; const="stove0-branch-set/v1" |  |
| `join` | no | anyOf=#/components/schemas/JoinDeclaration \| type="null" |  |
