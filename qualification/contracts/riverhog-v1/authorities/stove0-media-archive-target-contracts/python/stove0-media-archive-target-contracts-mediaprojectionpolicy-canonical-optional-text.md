...
- <a id="s-6f52e0a150"></a>`kind`: `"classmethod"`
- <a id="s-5d512e69f8"></a>`signature`: `"\"(cls, value: 'str \| None') -> 'str \| None'\""`
...
- <a id="pa-f9061e6ef1"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
