...
| Field | Value |
|---|---|
| <a id="s-4fadd69d09"></a>`scheme` | `"bearer"` |
| <a id="s-b098781e12"></a>`type` | `"http"` |

## Governing policies

- <a id="pa-b1b73dc9bc"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
