...
<!-- contract-element: http-schemas:riverhog-ftp-adapter:schemas-healthresponse:9ad6dc3cba -->
...
- <a id="s-a6f2b7aff8"></a>`additionalProperties`: `false`
- <a id="s-e135feaa53"></a>`required`: `["service","status"]`
...
- <a id="pa-8d902939f8"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
