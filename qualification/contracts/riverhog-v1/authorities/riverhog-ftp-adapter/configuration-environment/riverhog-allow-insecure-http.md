...
- <a id="pa-1bcca6bc7b"></a>[compatibility/configuration/v1](../../release/compatibility-guarantees/compatibility-configuration.md#p-8dc08bb461)
...
- [configuration-environment:riverhog-ftp-adapter:RIVERHOG_ALLOW_INSECURE_HTTP](../../../evidence/sources/authorities.md#src-8be0f96180) — [reference/riverhog/ingress/ftp/src/riverhog\_ftp\_adapter/config.py::load\_config](../../../../../../reference/riverhog/ingress/ftp/src/riverhog_ftp_adapter/config.py)
...
|---|---|---|---|
| parser | `riverhog-ftp-adapter` | [reference/riverhog/ingress/ftp/src/riverhog\_ftp\_adapter/config.py](../../../../../../reference/riverhog/ingress/ftp/src/riverhog_ftp_adapter/config.py) | `os.environ.get('RIVERHOG_ALLOW_INSECURE_HTTP', 'false')` |
