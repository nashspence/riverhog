...
| <a id="s-199cea8e22"></a>`name` | "RIVERHOG_EVENT_CONTEXT_REAP_BATCH_SIZE" |
...
|---|---|---|
| [RIVERHOG_EVENT_CONTEXT_REAP_BATCH_SIZE](#s-ee8d4c5bb2) | `value · configured-value · operational_policy` | shared above |

## Governing policies

- <a id="pa-62bbe8e979"></a>[compatibility/configuration/v1](../../../policies/index.md#p-8dc08bb461)
- <a id="pa-d565db79d8"></a>[extent-rule/configured-capacity/v1](../../../policies/index.md#p-3ebc61fc99)
...
- [configuration-environment:RIVERHOG_EVENT_CONTEXT_REAP_BATCH_SIZE](../../../evidence/sources.md#src-066eb69a6c) — `configuration-environment:RIVERHOG_EVENT_CONTEXT_REAP_BATCH_SIZE`
