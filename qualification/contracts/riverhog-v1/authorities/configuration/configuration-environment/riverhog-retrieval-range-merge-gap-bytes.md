...
| <a id="s-814b85f667"></a>`name` | "RIVERHOG_RETRIEVAL_RANGE_MERGE_GAP_BYTES" |
...
|---|---|---|
| [RIVERHOG_RETRIEVAL_RANGE_MERGE_GAP_BYTES](#s-91af6fdd5c) | `value · configured-value · operational_policy` | shared above |

## Governing policies

- <a id="pa-d6ee9e71d9"></a>[compatibility/configuration/v1](../../../policies/index.md#p-8dc08bb461)
- <a id="pa-c9bb459076"></a>[extent-rule/configured-capacity/v1](../../../policies/index.md#p-3ebc61fc99)
...
- [configuration-environment:RIVERHOG_RETRIEVAL_RANGE_MERGE_GAP_BYTES](../../../evidence/sources.md#src-4f7d119a27) — `configuration-environment:RIVERHOG_RETRIEVAL_RANGE_MERGE_GAP_BYTES`
