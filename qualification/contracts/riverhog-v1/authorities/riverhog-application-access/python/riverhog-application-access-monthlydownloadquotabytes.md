...
- <a id="s-368d4cd3fd"></a>`value`: `"typing.Annotated[int, FieldInfo(annotation=NoneType, required=True, metadata=[Ge(ge=0)]), BeforeValidator(func=<function validate_monthly_download_quota_bytes>, json_schema_input_type=PydanticUndefined)]"`
...
<!-- exact-contract-value: a33d0ac599fa6294cd33c5a2a60573a9f3c6cd949ee150f56d44abb6742745fc -->

```json
{
  "contract": {
    "kind": "type-alias",
    "value": "typing.Annotated[int, FieldInfo(annotation=NoneType, required=True, metadata=[Ge(ge=0)]), BeforeValidator(func=<function validate_monthly_download_quota_bytes>, json_schema_input_type=PydanticUndefined)]"
  },
