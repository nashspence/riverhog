...
- <a id="s-2b544eb330"></a>`kind`: `"function"`
- <a id="s-65378dd06e"></a>`signature`: `"\"(values: 'Iterable[ApplicationAccess \| tuple[str, str]]') -> 'tuple[ApplicationAccess, ...]'\""`

## Governing policies

- <a id="pa-7cbac118ef"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
