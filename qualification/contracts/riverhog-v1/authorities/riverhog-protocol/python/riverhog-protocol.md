...
<!-- contract-element: python:riverhog-protocol:riverhog-protocol:63459dade4 -->
...
| Family | [modules](index.md#f-4ee496e80f) |
| Contract elements | 1 |
| Extent decisions | 0 |
...
<!-- exact-contract-value: f5b05536ccacd1cf951f653b1a165901aa1b28d7f2365d05206a0973531abf31 -->

```json
{
  "candidate_id": "python:riverhog-protocol:riverhog_protocol",
  ...
  "exports": {
    ...
    "COLLECTION_DESCRIPTION_DOCUMENT_FORMAT": {
      "kind": "constant",
      "value": "riverhog-collection-description/v1"
    },
    ...
    "COLLECTION_TAG_NODE_FORMAT": {
      "kind": "constant",
      "value": "riverhog-collection-tag-node/v1"
    },
    ...
    "CollectionUploadState": {
      "kind": "type-alias",
      "value": "typing.Literal['open', 'closing', 'uploading', 'finalizing', 'orphaned', 'discarding']"
    },
    ...
    "DERIVATION_EVIDENCE_PATH": {
      "kind": "constant",
      "value": "riverhog/collection-derivation.json"
    },
    ...
    "PORTABLE_COLLECTION_FORMAT": {
      "kind": "constant",
      "value": "riverhog-collection/v1"
    },
    "PORTABLE_COLLECTION_INVENTORY_PAGE_FORMAT": {
      "kind": "constant",
      "value": "riverhog-collection-inventory-page/v1"
    },
    ...
    "PortableCollectionFile": {
      ...
      "members": {
        "from_mapping": {
          "kind": "classmethod",
          "signature": "\"(cls, value: 'object') -> 'PortableCollectionFile'\""
        },
        "to_mapping": {
          "kind": "method",
          "signature": "\"(self) -> 'dict[str, object]'\""
    ...
    "PortableCollectionHeader": {
      ...
      "members": {
        "validate_provenance_binding": {
          "kind": "method",
          "signature": "\"(self) -> 'PortableCollectionHeader'\""
        }
      },
    ...
    "PortableCollectionIdentityBuilder": {
      ...
      "members": {
        "add": {
          "kind": "method",
          "signature": "\"(self, file: 'PortableCollectionFile') -> 'None'\""
        },
        "identity": {
          "kind": "property",
          "signature": "\"(self) -> 'str'\""
