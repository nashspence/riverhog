...
- <a id="s-5c0b618ecc"></a>`kind`: `"classmethod"`
- <a id="s-cd1a2e813c"></a>`signature`: `"\"(cls, value: 'str') -> 'str'\""`
...
- <a id="pa-cf598a119d"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
