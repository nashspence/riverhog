...
- <a id="s-0ccc3bec1f"></a>`kind`: `"type-alias"`
- <a id="s-c1e706d598"></a>`value`: `"typing.Literal['app', 'key_id', 'permission', 'resource', 'created_at']"`

## Governing policies

- <a id="pa-2049ca408d"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
