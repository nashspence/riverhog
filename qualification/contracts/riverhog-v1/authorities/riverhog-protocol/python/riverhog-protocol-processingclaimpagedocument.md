...
- [ApplicationName](#s-85f26d76e7)
- [ArtifactSetIdentityDocument](#s-9eb1cbd883)
- [BrowsePageToken](#s-45f0983f59)
- [CollectionId](#s-40fd4aa997)
- [ExactSetIdentityDocument](#s-f7787ce7d5)
...
##### <a id="s-85f26d76e7"></a>definition `ApplicationName`

- <a id="s-57c11fbe32"></a>`type`: `"string"`
- <a id="s-770e1dbe1c"></a>`pattern`: `"^[a-z0-9]+(?:-[a-z0-9]+)*$"`

##### <a id="s-9eb1cbd883"></a>definition `ArtifactSetIdentityDocument`

- <a id="s-8ce0a8a743"></a>`type`: `"object"`
- <a id="s-772ae4fb1f"></a>`additionalProperties`: `false`
- <a id="s-d1ab794d33"></a>`required`: `["count","sha256","total_bytes"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-8dda04ecc8"></a>`count` | yes | [NonnegativeDecimal](#s-e156ec829d); ge=1 |  |
| <a id="s-45ec2d9e53"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-2716b8bb9a"></a>`total_bytes` | yes | [NonnegativeDecimal](#s-e156ec829d); ge=0 |  |
...
##### <a id="s-f7787ce7d5"></a>definition `ExactSetIdentityDocument`

- <a id="s-3cdfa57b35"></a>`type`: `"object"`
- <a id="s-b9996b38ef"></a>`additionalProperties`: `false`
- <a id="s-4d6fb3d570"></a>`required`: `["count","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-226eb62632"></a>`count` | yes | [NonnegativeDecimal](#s-e156ec829d); ge=1 |  |
| <a id="s-5c487372ba"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
| <a id="s-dca3f000ef"></a>`identity` | no | anyOf=[([ExactSetIdentityDocument](#s-f7787ce7d5)); (type="null")]; default=null |  |
...
| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-c3b9ebb342"></a>`app` | yes | [ApplicationName](#s-85f26d76e7) |  |
...
- <a id="s-53451c86b2"></a>`required`: `["outcomes","source_collection_retirement_policy","source_collection_retirement_grace_seconds"]`
...
| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-dec0678355"></a>`outcomes` | yes | [ExactSetIdentityDocument](#s-f7787ce7d5) |  |
| <a id="s-dab8e34b8d"></a>`source_collection_retirement_grace_seconds` | yes | [NonnegativeDecimal](#s-e156ec829d); ge=0 |  |
| <a id="s-7b35eae14e"></a>`source_collection_retirement_policy` | yes | type="string"; enum=["retain","retire-after-verified-output"] |  |
...
- <a id="s-205b08c15a"></a>`required`: `["execution_id","controller_evidence","controller_evidence_sha256","operation","inputs","artifacts","source_collection_retirement_policy","source_collection_retirement_grace_seconds","sealed_at"]`
...
| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-632cfa2299"></a>`artifacts` | yes | [ArtifactSetIdentityDocument](#s-9eb1cbd883) |  |
...
| <a id="s-8a3e1bf0b7"></a>`inputs` | yes | [ExactSetIdentityDocument](#s-f7787ce7d5) |  |
...
| <a id="s-2063f1c01e"></a>`source_collection_retirement_grace_seconds` | yes | [NonnegativeDecimal](#s-e156ec829d); ge=0 |  |
| <a id="s-6dce53d091"></a>`source_collection_retirement_policy` | yes | type="string"; enum=["retain","retire-after-verified-output"] |  |
...
| <a id="s-47346444fd"></a>`identity` | no | anyOf=[([ExactSetIdentityDocument](#s-f7787ce7d5)); (type="null")]; default=null |  |
...
| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-2ef075ce61"></a>`source_collection_retirement_policy` | no | const="retain" |  |
...
| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-34b7eb21df"></a>`source_collection_retirement_grace_seconds` | no | const="0" |  |
...
| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-ebd525f0f4"></a>`source_collection_retirement_policy` | no | const="retain" |  |
...
| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-db8a69c78a"></a>`source_collection_retirement_grace_seconds` | no | const="0" |  |
...
- <a id="pa-efe7905141"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
...
<!-- exact-contract-value: 44353fc299f01f221c77f22874505ecfa271712617dfcf1eb000905bcb708cae -->
