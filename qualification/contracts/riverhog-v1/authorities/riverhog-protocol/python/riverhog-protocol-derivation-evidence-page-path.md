...
- <a id="s-1787867923"></a>`kind`: `"function"`
- <a id="s-eef17c98b6"></a>`signature`: `"'(kind: \"Literal[\\'dispositions\\', \\'output-edges\\']\", start_ordinal: \\'int\\') -> \\'str\\''"`

## Governing policies

- <a id="pa-2315de6d32"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
