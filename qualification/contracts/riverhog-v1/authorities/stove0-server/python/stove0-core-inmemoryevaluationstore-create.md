...
- <a id="s-c23f039b05"></a>`kind`: `"method"`
- <a id="s-ec6ef65acc"></a>`signature`: `"\"(self, record: 'EvaluationRecord') -> 'EvaluationRecord'\""`
...
- <a id="pa-b30dfcad52"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
