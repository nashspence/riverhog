...
<!-- contract-element: schema:a-riverhog-ftp-spool:ftpspooldocument:e771fb9409 -->
...
- <a id="s-0be7fcdf62"></a>`description`: `"Operator document; credentials remain file paths until policy is valid."`
- <a id="s-ed297c6c47"></a>`required`: `["host_id","riverhog_base_url","sources","riverhog_token_file","api_token_file"]`
- <a id="s-0e81af0eea"></a>`title`: `"FtpSpoolDocument"`
...
| <a id="s-f7b70db9af"></a>`api_token_file` | yes | type="string"; format="path"; title="Api Token File" |  |
...
| <a id="s-a00a4344b9"></a>`riverhog_token_file` | yes | type="string"; format="path"; title="Riverhog Token File" |  |
...
- <a id="pa-9f254f4f83"></a>[compatibility/components/v1](../../release/compatibility-guarantees/compatibility-components.md#p-95e9a12259)
- <a id="pa-9169888516"></a>[extent-rule/no-semantic-maximum/v1](../../extent-contract/extent/extent-rule-no-semantic-maximum.md#p-574724b48a)
- <a id="pa-0b2693ec64"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
<!-- exact-contract-value: 48b6dfad08ae8adb059e37722bb6c50c237dab85e641effb807069265a35a8ae -->
