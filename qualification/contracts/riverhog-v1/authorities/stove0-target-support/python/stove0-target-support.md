...
<!-- contract-element: python:stove0-target-support:stove0-target-support:3b93c1aeb1 -->
...
- [python:stove0-target-support](../../../evidence/sources.md#src-86c8847b4f) — `reference/stove0/packages/target-support/src/stove0_target_support/__init__.py::<module>`
