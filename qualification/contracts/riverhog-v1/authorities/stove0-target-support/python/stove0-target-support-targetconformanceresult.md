...
- <a id="s-7e2d4f0738"></a>`required`: `["status","descriptor","coverage","operations"]`
...
| <a id="s-6a157d86b7"></a>`descriptor` | yes | [TargetDescriptor](#s-1afe6280cb) |  |
...
- [CollectionRootIdentityRef](#s-38953344da)
- [ContentObservationEvidence](#s-8bac3a116e)
- [ContentObservationFailure](#s-7d54b68f04)
- [ContentObservationInapplicable](#s-3a12963ebf)
- [ContentObservationRequest](#s-a6daaa87d5)
- [ContentObservationResult](#s-72eaa249ba)
- [ControllerEvidence](#s-d5dfdfd545)
- [DeclaredWorkspaceProtection](#s-1fab9f1e5f)
...
- [JsonSchemaValidationProfile](#s-674e66d9f2)
- [JsonValue](#s-770b4fc958)
- [NonnegativeDecimal](#s-433214af29)
- [ObserverImplementation](#s-f0d48ddd05)
- [OperationContract](#s-4c0679d4d1)
- [OperationIdentityRef](#s-10aaa7f773)
...
- [RecipeIdentityRef](#s-35cca82f63)
...
- [WorkArtifactSubject](#s-ae2205d690)
...
| <a id="s-e8344fc068"></a>`total_bytes` | yes | [NonnegativeDecimal](#s-433214af29); ge=0 |  |
...
| Alternative | Schema |
|---|---|
| <a id="s-9cbaaf3a5b"></a>1 | type="string"; pattern="^(?:0\|[1-9][0-9]{0,17}\|[1-8][0-9]{18}\|9[0-1][0-9]{17}\|92[0-1][0-9]{16}\|922[0-2][0-9]{15}\|9223[0-2][0-9]{14}\|92233[0-6][0-9]{13}\|922337[0-1][0-9]{12}\|92233720[0-2][0-9]{10}\|922337203[0-5][0-9]{9}\|9223372036[0-7][0-9]{8}\|92233720368[0-4][0-9]{7}\|922337203685[0-3][0-9]{6}\|9223372036854[0-6][0-9]{5}\|92233720368547[0-6][0-9]{4}\|922337203685477[0-4][0-9]{3}\|9223372036854775[0-7][0-9]{2}\|922337203685477580[0-6][0-9]{0}\|9223372036854775807)(?![\\s\\S])" |
| <a id="s-fec84ad613"></a>2 | not=(const="0") |

##### <a id="s-38953344da"></a>definition `CollectionRootIdentityRef`

- <a id="s-59979a8c21"></a>`type`: `"object"`
- <a id="s-c0169a91dc"></a>`additionalProperties`: `false`
- <a id="s-83ac4782f2"></a>`required`: `["collection_id","archive_root_sha256","content_identity"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-732c4a7215"></a>`archive_root_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-28bbf327ae"></a>`collection_id` | yes | [CollectionId](#s-72a858e21c) |  |
| <a id="s-d782434c88"></a>`content_identity` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |

##### <a id="s-8bac3a116e"></a>definition `ContentObservationEvidence`

- <a id="s-2ac2a693e6"></a>`type`: `"object"`
- <a id="s-978584244b"></a>`additionalProperties`: `false`
- <a id="s-ab1d82b7e4"></a>`required`: `["request","result"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-385b2fd1cf"></a>`request` | yes | [ContentObservationRequest](#s-a6daaa87d5) |  |
| <a id="s-64667c31b8"></a>`result` | yes | [ContentObservationResult](#s-72eaa249ba) |  |

##### <a id="s-7d54b68f04"></a>definition `ContentObservationFailure`

- <a id="s-21203ec4b8"></a>`type`: `"object"`
- <a id="s-fba09d0c17"></a>`additionalProperties`: `false`
- <a id="s-04a8f5d1df"></a>`required`: `["code","message","retryable"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-62634db296"></a>`code` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-d8520bd1ca"></a>`message` | yes | type="string"; maxLength=1000; minLength=1 |  |
| <a id="s-ae9630b958"></a>`retryable` | yes | type="boolean" |  |

##### <a id="s-3a12963ebf"></a>definition `ContentObservationInapplicable`

- <a id="s-35b2cdfd42"></a>`type`: `"object"`
- <a id="s-ea83f28c1d"></a>`additionalProperties`: `false`
- <a id="s-cdc52fd29e"></a>`required`: `["code","message"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-aaf7359b3c"></a>`code` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-37c758aabc"></a>`message` | yes | type="string"; maxLength=1000; minLength=1 |  |

##### <a id="s-a6daaa87d5"></a>definition `ContentObservationRequest`

- <a id="s-7d7a4b9900"></a>`type`: `"object"`
- <a id="s-823f642d75"></a>`additionalProperties`: `false`
- <a id="s-9bc448a276"></a>`required`: `["work_id","observer_registration_id","observer_descriptor_sha256","observer_contract_id","observer_contract_sha256","subjects","request_id"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-af88ae419e"></a>`format` | no | type="string"; const="stove0-observation-request/v1"; default="stove0-observation-request/v1" |  |
| <a id="s-5c7f480d62"></a>`maximum_result_bytes` | no | type="integer"; minimum=1; maximum=67108864; default=1048576 |  |
| <a id="s-122da02e37"></a>`observer_contract_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-0567e82ee6"></a>`observer_contract_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-472d066c08"></a>`observer_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-acaa65217a"></a>`observer_registration_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9.-]{0,118}[a-z0-9])?$" |  |
| <a id="s-f51d09e670"></a>`options` | no | type="object"; additionalProperties=([JsonValue](#s-770b4fc958)) |  |
| <a id="s-cca321ff83"></a>`request_id` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-35e4d829d9"></a>`retrieval_policy` | no | type="string"; enum=["available-only","allow"]; default="available-only" |  |
| <a id="s-99158dcc8a"></a>`subjects` | yes | type="array"; items=([WorkArtifactSubject](#s-ae2205d690)); minItems=1 |  |
| <a id="s-51d1936267"></a>`timeout_seconds` | no | type="integer"; minimum=1; maximum=86400; default=300 |  |
| <a id="s-3460e0127e"></a>`work_id` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |

##### <a id="s-72eaa249ba"></a>definition `ContentObservationResult`

- <a id="s-de40e9a848"></a>`type`: `"object"`
- <a id="s-9094b8a55c"></a>`additionalProperties`: `false`
- <a id="s-703a059b0d"></a>`required`: `["request_id","state","observer","observer_contract_id","observer_contract_sha256","subjects","result_sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-bdf21098ed"></a>`execution_evidence` | no | type="object"; additionalProperties=([JsonValue](#s-770b4fc958)) |  |
| <a id="s-db368755b9"></a>`facts` | no | anyOf=[(type="object"; additionalProperties=([JsonValue](#s-770b4fc958))); (type="null")]; default=null |  |
| <a id="s-c65560dcb1"></a>`facts_schema` | no | anyOf=[([JsonSchemaValidationProfile](#s-674e66d9f2)); (type="null")]; default=null |  |
| <a id="s-cadad75422"></a>`facts_sha256` | no | anyOf=[(type="string"; pattern="^[0-9a-f]{64}$"); (type="null")]; default=null |  |
| <a id="s-2f30e0534e"></a>`failure` | no | anyOf=[([ContentObservationFailure](#s-7d54b68f04)); (type="null")]; default=null |  |
| <a id="s-839482a52d"></a>`format` | no | type="string"; const="stove0-observation-result/v1"; default="stove0-observation-result/v1" |  |
| <a id="s-1cb144ce13"></a>`inapplicable` | no | anyOf=[([ContentObservationInapplicable](#s-3a12963ebf)); (type="null")]; default=null |  |
| <a id="s-e07fc9538c"></a>`observer` | yes | [ObserverImplementation](#s-f0d48ddd05) |  |
| <a id="s-1eb40724bc"></a>`observer_contract_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-3d701e769e"></a>`observer_contract_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-a2f18453df"></a>`request_id` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-4c5179a06c"></a>`result_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-05426d8ff3"></a>`state` | yes | type="string"; enum=["observed","inapplicable","failed","canceled"] |  |
| <a id="s-be5a12f0d3"></a>`subjects` | yes | type="array"; items=([WorkArtifactSubject](#s-ae2205d690)); minItems=1 |  |
...
##### <a id="s-1fab9f1e5f"></a>definition `DeclaredWorkspaceProtection`

- <a id="s-7b80168cc0"></a>`type`: `"string"`
- <a id="s-a7b4125e5d"></a>`enum`: `["encrypted-at-rest","memory-backed"]`

##### <a id="s-c6acdd3519"></a>definition `EffectPlan`

- <a id="s-072ecf07b7"></a>`type`: `"object"`
- <a id="s-20de4414a8"></a>`additionalProperties`: `false`
- <a id="s-4210364006"></a>`required`: `["operation_id","operation_contract_sha256","inputs","intent","target_implementation_id","target_descriptor_sha256","plan_sha256"]`
...
| <a id="s-1df7bf17d6"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="s-1499942a35"></a>`required`: `["job_id","request_sha256","target_descriptor_sha256","operation_contract_sha256","plan_sha256","execution_sha256","result","receipt_sha256"]`
...
| <a id="s-0f3403228b"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
##### <a id="s-674e66d9f2"></a>definition `JsonSchemaValidationProfile`

- <a id="s-69a44b1cc6"></a>`type`: `"object"`
- <a id="s-dbaa021677"></a>`additionalProperties`: `false`
- <a id="s-97c99a3ef4"></a>`required`: `["id","profile_sha256","schema"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-5e375c19b0"></a>`dialect` | no | type="string"; const="https://json-schema.org/draft/2020-12/schema"; default="https://json-schema.org/draft/2020-12/schema" |  |
| <a id="s-c5fb154973"></a>`format_policy` | no | type="string"; const="annotation-only"; default="annotation-only" |  |
| <a id="s-8a44545a74"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-cc1831b885"></a>`profile_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-0943ee170d"></a>`schema` | yes | type="object"; additionalProperties=([JsonValue](#s-770b4fc958)) |  |

##### <a id="s-770b4fc958"></a>definition `JsonValue`

- Accepts: any JSON value.

##### <a id="s-433214af29"></a>definition `NonnegativeDecimal`

- <a id="s-6bbc8e5348"></a>`type`: `"string"`
- <a id="s-fff8ef3088"></a>`pattern`: `"^(?:0\|[1-9][0-9]*)(?![\\s\\S])"`
...
| <a id="s-036b5412bd"></a>`effect_receipt_schema` | no | anyOf=[([JsonSchemaValidationProfile](#s-674e66d9f2)); (type="null")]; default=null |  |
...
| <a id="s-8e18f5b695"></a>`intent_schema` | yes | [JsonSchemaValidationProfile](#s-674e66d9f2) |  |
...
##### <a id="s-10aaa7f773"></a>definition `OperationIdentityRef`

- <a id="s-ebbf132b6f"></a>`type`: `"object"`
- <a id="s-11aa0eca97"></a>`additionalProperties`: `false`
- <a id="s-52522f4c9d"></a>`required`: `["id","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-429d477c9c"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-1f3a39444b"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
| <a id="s-7ef2a224e8"></a>`total_bytes` | yes | [NonnegativeDecimal](#s-433214af29); ge=0 |  |
...
##### <a id="s-35cca82f63"></a>definition `RecipeIdentityRef`

- <a id="s-11e9c9df1e"></a>`type`: `"object"`
- <a id="s-7ab40653b7"></a>`additionalProperties`: `false`
- <a id="s-ee17af1f1b"></a>`required`: `["id","revision","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-f66526624a"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-f09d098688"></a>`revision` | yes | [NonnegativeDecimal](#s-433214af29); ge=1 |  |
| <a id="s-70a0cf03ab"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
##### <a id="s-1afe6280cb"></a>definition `TargetDescriptor`

- <a id="s-3b2fd10c65"></a>`type`: `"object"`
- <a id="s-f4cec89a43"></a>`additionalProperties`: `false`
- <a id="s-e22ab474b9"></a>`required`: `["implementation_id","implementation_version","source_revision","image_id","operations","descriptor_sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-08b6d438ea"></a>`descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-26db1721cc"></a>`image_id` | yes | type="string"; pattern="^sha256:[0-9a-f]{64}$" |  |
| <a id="s-f9bcf7c653"></a>`implementation_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-9c782a6c53"></a>`implementation_version` | yes | type="string"; maxLength=120; minLength=1 |  |
| <a id="s-a007b145a1"></a>`operations` | yes | type="array"; items=([TargetOperationSupport](#s-e2738e9866)); minItems=1 |  |
| <a id="s-f814471ba8"></a>`protocol` | no | type="string"; enum=["stove0-transform-target/v1","stove0-effect-target/v1"]; default="stove0-transform-target/v1" |  |
| <a id="s-eb2f0f57c0"></a>`source_revision` | yes | type="string"; maxLength=200; minLength=1 |  |
| <a id="s-eda23a639a"></a>`transport` | no | type="string"; const="riverhog-capability/v1"; default="riverhog-capability/v1" |  |
...
- <a id="s-20ea6f10b8"></a>`required`: `["target_descriptor_sha256","operation_contract_sha256","plan_sha256","execution_sha256"]`
...
| <a id="s-7e87f86be2"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="s-c04d0f3383"></a>`required`: `["job_id","claim_id","fence","controller_evidence","plan","declared_workspace_protection"]`
...
| <a id="s-5fde7da322"></a>`declared_workspace_protection` | yes | [DeclaredWorkspaceProtection](#s-1fab9f1e5f) |  |
...
- <a id="s-5fe754ea91"></a>`required`: `["operation_id","operation_contract_sha256","result_kind","options_schema_profile_sha256","semantic_conformance"]`
...
| <a id="s-503405a3a8"></a>`options_schema_profile_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
| <a id="s-a00bf6cde7"></a>`options_schema` | yes | [JsonSchemaValidationProfile](#s-674e66d9f2) |  |
...
- <a id="s-4092ab608a"></a>`required`: `["protocol","target_implementation_id","target_descriptor_sha256","operation_contract_sha256","plan","plan_sha256"]`
...
| <a id="s-7c8d578cad"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
| <a id="s-a993344de7"></a>`observations` | no | type="array"; default=[]; items=([ContentObservationEvidence](#s-8bac3a116e)) |  |
...
- <a id="s-f03e785cc2"></a>`required`: `["descriptor","plan"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-da769525fd"></a>`descriptor` | yes | [TargetDescriptor](#s-1afe6280cb) |  |
...
- <a id="s-a4ddbe7482"></a>`required`: `["operation_id","operation_contract_sha256","inputs","intent","target_implementation_id","target_descriptor_sha256","plan_sha256"]`
...
| <a id="s-beca053d15"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
##### <a id="s-ae2205d690"></a>definition `WorkArtifactSubject`

- <a id="s-6274e2e13d"></a>`type`: `"object"`
- <a id="s-28bb5c9a50"></a>`additionalProperties`: `false`
- <a id="s-70c0a6f744"></a>`required`: `["id","role","collection","path","bytes","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-099510b5e6"></a>`bytes` | yes | [NonnegativeDecimal](#s-433214af29); ge=0 |  |
| <a id="s-106f75f781"></a>`collection` | yes | [CollectionRootIdentityRef](#s-38953344da) |  |
| <a id="s-7a1467ebf2"></a>`id` | yes | type="string"; pattern="^[A-Za-z0-9]&#40;?:[A-Za-z0-9._-]{0,158}[A-Za-z0-9])?$" |  |
| <a id="s-1fa1db6050"></a>`media_type` | no | anyOf=[(type="string"; maxLength=255; minLength=1); (type="null")]; default=null |  |
| <a id="s-0c06af6ccc"></a>`path` | yes | type="string"; maxLength=4096; minLength=1 |  |
| <a id="s-13a765f000"></a>`role` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-91382a4160"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
| <a id="s-c28c11a742"></a>`inputs` | yes | type="array"; items=([CollectionRootIdentityRef](#s-38953344da)); minItems=1 |  |
| <a id="s-5eb6689302"></a>`recipe` | yes | [RecipeIdentityRef](#s-35cca82f63) |  |
...
- <a id="s-9cd90390be"></a>`required`: `["work","operation","target_registration_id","target_descriptor_sha256","workflow_plan_sha256"]`
...
| <a id="s-899d92fe58"></a>`observations` | no | type="array"; default=[]; items=([ContentObservationEvidence](#s-8bac3a116e)) |  |
| <a id="s-8440beafb9"></a>`operation` | yes | [OperationIdentityRef](#s-10aaa7f773) |  |
...
- <a id="pa-9ffbbb9306"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
...
<!-- exact-contract-value: 7bb7a67795f37f4cb2fe721745c035367678b847981ce0dbc17f43a139ae9bfb -->
