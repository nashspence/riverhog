...
- <a id="s-f97fdad5e3"></a>`required`: `["operation_id","operation_contract_sha256","inputs","intent","target_implementation_id","target_contract_sha256"]`
...
| <a id="s-d1b6c87e22"></a>`total_bytes` | yes | type="integer"; minimum=0 |  |
