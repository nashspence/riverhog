...
- <a id="s-ffea94f35c"></a>`kind`: `"property"`
- <a id="s-d3e8a7e8a7"></a>`signature`: `"\"(self) -> 'bool'\""`
...
- <a id="pa-3a1df994dc"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
