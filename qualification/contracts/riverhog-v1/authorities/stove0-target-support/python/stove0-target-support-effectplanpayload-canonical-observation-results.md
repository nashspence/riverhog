...
- <a id="s-11ec692052"></a>`kind`: `"classmethod"`
- <a id="s-c677a9256f"></a>`signature`: `"\"(cls, value: 'tuple[str, ...]') -> 'tuple[str, ...]'\""`
...
- <a id="pa-4378bfe6b0"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
