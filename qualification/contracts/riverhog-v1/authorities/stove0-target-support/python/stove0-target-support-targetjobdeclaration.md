...
- <a id="s-4b6278c416"></a>`required`: `["job_id","claim_id","fence","controller_evidence","plan","declared_workspace_protection"]`
...
| <a id="s-c5cb024eaf"></a>`declared_workspace_protection` | yes | [DeclaredWorkspaceProtection](#s-fa7c844a20) |  |
...
- [CollectionRootIdentityRef](#s-623e6d5dad)
- [ContentObservationEvidence](#s-61246142d9)
- [ContentObservationFailure](#s-19f2c87a9c)
- [ContentObservationInapplicable](#s-68ce18809f)
- [ContentObservationRequest](#s-4267e6f02b)
- [ContentObservationResult](#s-5f54bbd61d)
- [ControllerEvidence](#s-73dba491c8)
- [DeclaredWorkspaceProtection](#s-fa7c844a20)
...
- [NonnegativeDecimal](#s-60d5f25ee1)
- [ObserverImplementation](#s-2f95dafde9)
- [OperationIdentityRef](#s-86961923f9)
- [RecipeIdentityRef](#s-18a2a554f9)
...
- [WorkArtifactSubject](#s-3129df2e4c)
...
| Alternative | Schema |
|---|---|
| <a id="s-534d58b2fb"></a>1 | type="string"; pattern="^(?:0\|[1-9][0-9]{0,17}\|[1-8][0-9]{18}\|9[0-1][0-9]{17}\|92[0-1][0-9]{16}\|922[0-2][0-9]{15}\|9223[0-2][0-9]{14}\|92233[0-6][0-9]{13}\|922337[0-1][0-9]{12}\|92233720[0-2][0-9]{10}\|922337203[0-5][0-9]{9}\|9223372036[0-7][0-9]{8}\|92233720368[0-4][0-9]{7}\|922337203685[0-3][0-9]{6}\|9223372036854[0-6][0-9]{5}\|92233720368547[0-6][0-9]{4}\|922337203685477[0-4][0-9]{3}\|9223372036854775[0-7][0-9]{2}\|922337203685477580[0-6][0-9]{0}\|9223372036854775807)(?![\\s\\S])" |
| <a id="s-46a51885f3"></a>2 | not=(const="0") |

##### <a id="s-623e6d5dad"></a>definition `CollectionRootIdentityRef`

- <a id="s-cb354de77c"></a>`type`: `"object"`
- <a id="s-330a28b8af"></a>`additionalProperties`: `false`
- <a id="s-31fae62be2"></a>`required`: `["collection_id","archive_root_sha256","content_identity"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-59c4a3793e"></a>`archive_root_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-daf848d9ca"></a>`collection_id` | yes | [CollectionId](#s-a68e2629c1) |  |
| <a id="s-61bb7f0131"></a>`content_identity` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |

##### <a id="s-61246142d9"></a>definition `ContentObservationEvidence`

- <a id="s-c2049a07ec"></a>`type`: `"object"`
- <a id="s-1e79eeac85"></a>`additionalProperties`: `false`
- <a id="s-84c5f30925"></a>`required`: `["request","result"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-08e413c380"></a>`request` | yes | [ContentObservationRequest](#s-4267e6f02b) |  |
| <a id="s-78ed39a3ae"></a>`result` | yes | [ContentObservationResult](#s-5f54bbd61d) |  |

##### <a id="s-19f2c87a9c"></a>definition `ContentObservationFailure`

- <a id="s-067294bc24"></a>`type`: `"object"`
- <a id="s-776b2a2b6f"></a>`additionalProperties`: `false`
- <a id="s-38680ce62c"></a>`required`: `["code","message","retryable"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-6766ad150b"></a>`code` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-5c96ef6498"></a>`message` | yes | type="string"; maxLength=1000; minLength=1 |  |
| <a id="s-0085a0179f"></a>`retryable` | yes | type="boolean" |  |

##### <a id="s-68ce18809f"></a>definition `ContentObservationInapplicable`

- <a id="s-f2198bc1e3"></a>`type`: `"object"`
- <a id="s-10f0f19120"></a>`additionalProperties`: `false`
- <a id="s-6427f91784"></a>`required`: `["code","message"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-32397486ce"></a>`code` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-8ec3dd50e8"></a>`message` | yes | type="string"; maxLength=1000; minLength=1 |  |

##### <a id="s-4267e6f02b"></a>definition `ContentObservationRequest`

- <a id="s-4bbe3e86f1"></a>`type`: `"object"`
- <a id="s-a83094ee52"></a>`additionalProperties`: `false`
- <a id="s-3eb251fb86"></a>`required`: `["work_id","observer_registration_id","observer_descriptor_sha256","observer_contract_id","observer_contract_sha256","subjects","request_id"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-a18c903be0"></a>`format` | no | type="string"; const="stove0-observation-request/v1"; default="stove0-observation-request/v1" |  |
| <a id="s-09f28eb920"></a>`maximum_result_bytes` | no | type="integer"; minimum=1; maximum=67108864; default=1048576 |  |
| <a id="s-725dc00d0b"></a>`observer_contract_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-08dfc0d106"></a>`observer_contract_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-473a2effc4"></a>`observer_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-4c64045b98"></a>`observer_registration_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9.-]{0,118}[a-z0-9])?$" |  |
| <a id="s-70d93d6cc2"></a>`options` | no | type="object"; additionalProperties=([JsonValue](#s-171969873a)) |  |
| <a id="s-fe31ca11fa"></a>`request_id` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-cb88085146"></a>`retrieval_policy` | no | type="string"; enum=["available-only","allow"]; default="available-only" |  |
| <a id="s-2ec5d3a3d5"></a>`subjects` | yes | type="array"; items=([WorkArtifactSubject](#s-3129df2e4c)); minItems=1 |  |
| <a id="s-8a57c9002b"></a>`timeout_seconds` | no | type="integer"; minimum=1; maximum=86400; default=300 |  |
| <a id="s-3a9eaebe77"></a>`work_id` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |

##### <a id="s-5f54bbd61d"></a>definition `ContentObservationResult`

- <a id="s-e5f4b5ac37"></a>`type`: `"object"`
- <a id="s-c8c991726c"></a>`additionalProperties`: `false`
- <a id="s-51a4df5114"></a>`required`: `["request_id","state","observer","observer_contract_id","observer_contract_sha256","subjects","result_sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-44fa521a1f"></a>`execution_evidence` | no | type="object"; additionalProperties=([JsonValue](#s-171969873a)) |  |
| <a id="s-04b9285d33"></a>`facts` | no | anyOf=[(type="object"; additionalProperties=([JsonValue](#s-171969873a))); (type="null")]; default=null |  |
| <a id="s-3b36f19f57"></a>`facts_schema` | no | anyOf=[([JsonSchemaValidationProfile](#s-5aefee9502)); (type="null")]; default=null |  |
| <a id="s-767550a9d7"></a>`facts_sha256` | no | anyOf=[(type="string"; pattern="^[0-9a-f]{64}$"); (type="null")]; default=null |  |
| <a id="s-9c67d3c4ac"></a>`failure` | no | anyOf=[([ContentObservationFailure](#s-19f2c87a9c)); (type="null")]; default=null |  |
| <a id="s-408a78a4dc"></a>`format` | no | type="string"; const="stove0-observation-result/v1"; default="stove0-observation-result/v1" |  |
| <a id="s-5c4520ac4e"></a>`inapplicable` | no | anyOf=[([ContentObservationInapplicable](#s-68ce18809f)); (type="null")]; default=null |  |
| <a id="s-d9ff5c29c1"></a>`observer` | yes | [ObserverImplementation](#s-2f95dafde9) |  |
| <a id="s-0ef3698df3"></a>`observer_contract_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-01d84cb061"></a>`observer_contract_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-c098978a07"></a>`request_id` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-6dbb9e5da8"></a>`result_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-2e3c7be75e"></a>`state` | yes | type="string"; enum=["observed","inapplicable","failed","canceled"] |  |
| <a id="s-2aa2208efa"></a>`subjects` | yes | type="array"; items=([WorkArtifactSubject](#s-3129df2e4c)); minItems=1 |  |
...
##### <a id="s-fa7c844a20"></a>definition `DeclaredWorkspaceProtection`

- <a id="s-0096fa8ce0"></a>`type`: `"string"`
- <a id="s-2323bcbc56"></a>`enum`: `["encrypted-at-rest","memory-backed"]`

##### <a id="s-dec311e248"></a>definition `EffectPlan`

- <a id="s-cb344248b2"></a>`type`: `"object"`
- <a id="s-8a8d3ff0b2"></a>`additionalProperties`: `false`
- <a id="s-7ed2eff047"></a>`required`: `["operation_id","operation_contract_sha256","inputs","intent","target_implementation_id","target_descriptor_sha256","plan_sha256"]`
...
| <a id="s-aced69d3f5"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
##### <a id="s-60d5f25ee1"></a>definition `NonnegativeDecimal`

- <a id="s-4f960f1945"></a>`type`: `"string"`
- <a id="s-5b20d5a252"></a>`pattern`: `"^(?:0\|[1-9][0-9]*)(?![\\s\\S])"`
...
##### <a id="s-86961923f9"></a>definition `OperationIdentityRef`

- <a id="s-2db41cb640"></a>`type`: `"object"`
- <a id="s-169f559792"></a>`additionalProperties`: `false`
- <a id="s-aaf9fb4af3"></a>`required`: `["id","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-bd8811ad99"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-ea31f0b04f"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |

##### <a id="s-18a2a554f9"></a>definition `RecipeIdentityRef`

- <a id="s-5f8e33bc10"></a>`type`: `"object"`
- <a id="s-80fa218fe5"></a>`additionalProperties`: `false`
- <a id="s-c4f00fbb32"></a>`required`: `["id","revision","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-64ac620690"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-f68eec3a19"></a>`revision` | yes | [NonnegativeDecimal](#s-60d5f25ee1); ge=1 |  |
| <a id="s-095820ea95"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="s-6e8d048210"></a>`required`: `["protocol","target_implementation_id","target_descriptor_sha256","operation_contract_sha256","plan","plan_sha256"]`
...
| <a id="s-dee0a1d41e"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="s-ba793447fd"></a>`required`: `["operation_id","operation_contract_sha256","inputs","intent","target_implementation_id","target_descriptor_sha256","plan_sha256"]`
...
| <a id="s-aa874a3e2e"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
##### <a id="s-3129df2e4c"></a>definition `WorkArtifactSubject`

- <a id="s-56ad90fb52"></a>`type`: `"object"`
- <a id="s-332a159708"></a>`additionalProperties`: `false`
- <a id="s-fe9200dd56"></a>`required`: `["id","role","collection","path","bytes","sha256"]`
...
| <a id="s-51b3b65a5f"></a>`path` | yes | type="string"; maxLength=4096; minLength=1 |  |
| <a id="s-d83b927e52"></a>`role` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-7dacc3a69f"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
| <a id="s-e1263ab545"></a>`inputs` | yes | type="array"; items=([CollectionRootIdentityRef](#s-623e6d5dad)); minItems=1 |  |
| <a id="s-f28ff63148"></a>`recipe` | yes | [RecipeIdentityRef](#s-18a2a554f9) |  |
...
- <a id="s-9961c946d8"></a>`required`: `["work","operation","target_registration_id","target_descriptor_sha256","workflow_plan_sha256"]`
...
| <a id="s-c1e0c004f8"></a>`observations` | no | type="array"; default=[]; items=([ContentObservationEvidence](#s-61246142d9)) |  |
| <a id="s-bad511730f"></a>`operation` | yes | [OperationIdentityRef](#s-86961923f9) |  |
...
| <a id="s-d4d78dc0ed"></a>`source_collection_retirement_grace_seconds` | no | type="integer"; minimum=0; default=0 |  |
| <a id="s-8e047c9b34"></a>`source_collection_retirement_policy` | no | type="string"; enum=["retain","retire-after-verified-output"]; default="retain" |  |
| <a id="s-30016919c7"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
