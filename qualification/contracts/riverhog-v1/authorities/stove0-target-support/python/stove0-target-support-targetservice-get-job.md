...
- <a id="s-260ab8bc5f"></a>`kind`: `"method"`
- <a id="s-af4ef970f3"></a>`signature`: `"\"(self, job_id: 'str') -> 'TargetJobStatus'\""`
...
- <a id="pa-7b0720a946"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
