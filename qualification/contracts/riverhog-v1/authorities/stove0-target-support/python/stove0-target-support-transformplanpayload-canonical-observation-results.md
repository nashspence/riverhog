...
- <a id="s-f3eb64480a"></a>`kind`: `"classmethod"`
- <a id="s-a5fc82e4e4"></a>`signature`: `"\"(cls, value: 'tuple[str, ...]') -> 'tuple[str, ...]'\""`
...
- <a id="pa-9f1f91be3c"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
