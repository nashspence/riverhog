# stove0-target-support: Process Protocol Operations
...
- [POST /v1/jobs/{job_id}/cancel](post-v1-jobs-job-id-cancel.md)
- [POST /v1/preflight](post-v1-preflight.md)
- [PUT /v1/jobs/{job_id}](put-v1-jobs-job-id.md)
