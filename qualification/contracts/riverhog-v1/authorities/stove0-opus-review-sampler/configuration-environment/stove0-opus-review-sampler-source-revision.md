...
- [configuration-environment:stove0-opus-review-sampler:STOVE0_OPUS_REVIEW_SAMPLER_SOURCE_REVISION](../../../evidence/sources.md#src-91897194ea) — `reference/stove0/targets/opus/review-sampler/src/stove0_opus_review_sampler/app.py`
...
|---|---|---|---|
| parser | `stove0-opus-review-sampler` | `reference/stove0/targets/opus/review-sampler/src/stove0_opus_review_sampler/app.py` | `os.getenv(f'{prefix}_SOURCE_REVISION', 'unknown')` |
