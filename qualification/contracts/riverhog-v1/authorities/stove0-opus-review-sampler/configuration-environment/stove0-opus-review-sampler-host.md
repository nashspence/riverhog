...
- [configuration-environment:stove0-opus-review-sampler:STOVE0_OPUS_REVIEW_SAMPLER_HOST](../../../evidence/sources.md#src-7e5f631953) — `reference/stove0/targets/opus/review-sampler/src/stove0_opus_review_sampler/app.py`
...
|---|---|---|---|
| parser | `stove0-opus-review-sampler` | `reference/stove0/targets/opus/review-sampler/src/stove0_opus_review_sampler/app.py` | `os.getenv(f'{prefix}_HOST', '127.0.0.1')` |
