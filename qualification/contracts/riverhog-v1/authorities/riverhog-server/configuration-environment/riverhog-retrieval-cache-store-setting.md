...
| <a id="s-309f59ad52"></a>`parameters · setting` | `["ADAPTER_URL","ADAPTER_TOKEN_FILE","ADAPTER_ALLOW_INSECURE_HTTP","ADAPTER_MAX_CONNECTIONS","ADAPTER_TIMEOUT_SECONDS","ADMISSION_ENABLED","ADMISSION_BUDGET_BYTES"]` |
| <a id="s-602359dab4"></a>`parameters · store · normalization` | `"uppercase-dashes-to-underscores"` |
| <a id="s-94f3d62b6c"></a>`parameters · store · source` | `"RIVERHOG_RETRIEVAL_CACHE_STORES"` |
...
- <a id="pa-b43dad48d0"></a>[compatibility/configuration/v1](../../release/compatibility-guarantees/compatibility-configuration.md#p-8dc08bb461)
- <a id="pa-dac115e962"></a>[extent-rule/configured-capacity/v1](../../extent-contract/extent/extent-rule-configured-capacity.md#p-3ebc61fc99)
...
- [configuration-environment-pattern:riverhog-server:RIVERHOG_RETRIEVAL_CACHE_{store}_{setting}](../../../evidence/sources/authorities.md#src-956dbca0d9) — [riverhog/src/riverhog\_core/runtime\_config.py](../../../../../../riverhog/src/riverhog_core/runtime_config.py)
...
|---|---|---|---|
| parser | `riverhog-server` | [riverhog/src/riverhog\_core/runtime\_config.py](../../../../../../riverhog/src/riverhog_core/runtime_config.py) | `_retrieval_cache_store_environment_name` |
