...
| <a id="s-7487ad020a"></a>`options_schema` | yes | [JsonSchemaValidationProfile](#s-4d216f06dc) |  |
| <a id="s-31423e02bf"></a>`result_kind` | no | type="string"; enum=["collection","external-effect"]; default="collection" |  |

##### Definitions

- [JsonSchemaValidationProfile](#s-4d216f06dc)
- [JsonValue](#s-8a10c7d7ba)

##### <a id="s-4d216f06dc"></a>definition `JsonSchemaValidationProfile`

- <a id="s-855b6b3a83"></a>`type`: `"object"`
- <a id="s-00250b9842"></a>`additionalProperties`: `false`
- <a id="s-69b1b2493f"></a>`required`: `["id","profile_sha256","schema"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-c9f51832b4"></a>`dialect` | no | type="string"; const="https://json-schema.org/draft/2020-12/schema"; default="https://json-schema.org/draft/2020-12/schema" |  |
| <a id="s-988df887f1"></a>`format_policy` | no | type="string"; const="annotation-only"; default="annotation-only" |  |
| <a id="s-e8500aebb9"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-6d9c9027ad"></a>`profile_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-ef007486c7"></a>`schema` | yes | type="object"; additionalProperties=([JsonValue](#s-8a10c7d7ba)) |  |
...
<!-- exact-contract-value: baf034ed2602989c141e715c8d26e209e2c73fa39f5d789955a2d5b14a44158b -->
