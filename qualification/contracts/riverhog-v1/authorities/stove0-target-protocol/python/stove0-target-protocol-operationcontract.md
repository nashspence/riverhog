...
| <a id="s-a7dc046b5b"></a>`effect_receipt_schema` | no | anyOf=[([JsonSchemaValidationProfile](#s-07d8d60cba)); (type="null")]; default=null |  |
...
| <a id="s-96c8da7257"></a>`intent_schema` | yes | [JsonSchemaValidationProfile](#s-07d8d60cba) |  |
...
| <a id="s-c3c0e82dc4"></a>`source_collection_retirement_permitted` | no | type="boolean"; default=false |  |

##### Definitions

- [InputArtifactContract](#s-1a2857588b)
- [JsonSchemaValidationProfile](#s-07d8d60cba)
...
##### <a id="s-07d8d60cba"></a>definition `JsonSchemaValidationProfile`

- <a id="s-bc2742b58b"></a>`type`: `"object"`
- <a id="s-890ce5cb1e"></a>`additionalProperties`: `false`
- <a id="s-07813cc266"></a>`required`: `["id","profile_sha256","schema"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-73cc6dec06"></a>`dialect` | no | type="string"; const="https://json-schema.org/draft/2020-12/schema"; default="https://json-schema.org/draft/2020-12/schema" |  |
| <a id="s-382ea4aa87"></a>`format_policy` | no | type="string"; const="annotation-only"; default="annotation-only" |  |
| <a id="s-2eae85ca3e"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-a31ebfe549"></a>`profile_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-072d272feb"></a>`schema` | yes | type="object"; additionalProperties=([JsonValue](#s-b33e771e6c)) |  |
...
- <a id="pa-85c4934a60"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
...
<!-- exact-contract-value: 4a741d00fdbdf911e3e823be9dafed04f98b62b1572b974d7dae9c1d6e2308f3 -->
