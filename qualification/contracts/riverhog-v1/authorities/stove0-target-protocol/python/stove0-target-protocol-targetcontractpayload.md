...
- [JsonSchemaValidationProfile](#s-fed22773f3)
- [JsonValue](#s-fcfc17375a)
- [TargetOperationSupport](#s-19ce961c7e)

##### <a id="s-fed22773f3"></a>definition `JsonSchemaValidationProfile`

- <a id="s-6f283846a5"></a>`type`: `"object"`
- <a id="s-dff8c97510"></a>`additionalProperties`: `false`
- <a id="s-b69d5cd171"></a>`required`: `["id","profile_sha256","schema"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-5175051511"></a>`dialect` | no | type="string"; const="https://json-schema.org/draft/2020-12/schema"; default="https://json-schema.org/draft/2020-12/schema" |  |
| <a id="s-fe35cabfff"></a>`format_policy` | no | type="string"; const="annotation-only"; default="annotation-only" |  |
| <a id="s-fae960d610"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-36fb97fd47"></a>`profile_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-1d2dbc8f14"></a>`schema` | yes | type="object"; additionalProperties=([JsonValue](#s-fcfc17375a)) |  |
...
| <a id="s-26a8c65a16"></a>`options_schema` | yes | [JsonSchemaValidationProfile](#s-fed22773f3) |  |
...
- <a id="pa-ddbe730940"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
...
<!-- exact-contract-value: 9c3c2fedb4db33632d3fe84f3887aa30167611d901feecc2277911988b2b636d -->
