...
- <a id="s-b700f75939"></a>`required`: `["implementation_id","implementation_version","source_revision","image_id","operations","descriptor_sha256"]`
...
| <a id="s-1d77ab8e5c"></a>`image_id` | yes | type="string"; pattern="^sha256:[0-9a-f]{64}$" |  |
