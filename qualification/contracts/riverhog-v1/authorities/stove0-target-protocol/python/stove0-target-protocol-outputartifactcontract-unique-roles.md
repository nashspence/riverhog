...
- <a id="s-0d3be7e75a"></a>`kind`: `"classmethod"`
- <a id="s-1d29f38dcb"></a>`signature`: `"\"(cls, value: 'tuple[str, ...]') -> 'tuple[str, ...]'\""`
...
- <a id="pa-da1ff74faa"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
