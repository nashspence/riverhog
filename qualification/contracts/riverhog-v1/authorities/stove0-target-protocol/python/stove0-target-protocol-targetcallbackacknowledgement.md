...
- <a id="s-61388af1d8"></a>`additionalProperties`: `false`

##### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-9052757ae9"></a>`accepted` | no | type="boolean"; const=true; default=true |  |

## Governing policies

- <a id="pa-8bedfac872"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
