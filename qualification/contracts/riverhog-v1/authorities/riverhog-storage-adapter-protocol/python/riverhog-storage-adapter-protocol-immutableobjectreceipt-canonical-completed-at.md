...
- <a id="s-d4af4cba3b"></a>`kind`: `"classmethod"`
- <a id="s-2b21cb89df"></a>`signature`: `"\"(cls, value: 'str') -> 'str'\""`
...
- <a id="pa-d6441bcc4d"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
