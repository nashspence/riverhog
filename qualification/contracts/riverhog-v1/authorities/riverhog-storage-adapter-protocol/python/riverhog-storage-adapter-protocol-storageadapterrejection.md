...
- <a id="s-f5a10a5397"></a>`kind`: `"class"`
- <a id="s-da9b96b1da"></a>`signature`: `"\"(code: 'StorageAdapterErrorCode', message: 'str') -> 'None'\""`

## Governing policies

- <a id="pa-d9783e7ab3"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
