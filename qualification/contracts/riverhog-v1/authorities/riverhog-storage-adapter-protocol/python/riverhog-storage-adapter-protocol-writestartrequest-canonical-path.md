...
- <a id="s-3db5e14d4d"></a>`kind`: `"classmethod"`
- <a id="s-072baa439d"></a>`signature`: `"\"(cls, value: 'str') -> 'str'\""`
...
- <a id="pa-2f225e58a4"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
