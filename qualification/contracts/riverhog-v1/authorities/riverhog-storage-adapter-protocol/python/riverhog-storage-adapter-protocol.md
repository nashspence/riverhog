...
<!-- contract-element: python:riverhog-storage-adapter-protocol:riverhog-storage-adapter-protocol:4d3b43e6ea -->
...
| Family | [modules](index.md#f-93a6330628) |
| Contract elements | 1 |
| Extent decisions | 0 |
...
- `/external_contract/python/28`

### Exact owned JSON

The following JSON is the complete value owned at each machine-authority pointer. No contractual fields are summarized away.

<!-- exact-contract-value: 0c4723010f1cfa8fbe5efaf2afab7dd9875fb2da636ef3ce5d20631e8a6a906f -->

```json
{
  "candidate_id": "python:riverhog-storage-adapter-protocol:riverhog_storage_adapter_protocol",
