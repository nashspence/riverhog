...
- <a id="s-f9efcac9db"></a>`kind`: `"method"`
- <a id="s-18804f4d41"></a>`signature`: `"\"(self, request: 'WriteStartRequest') -> 'WriteSession'\""`
...
- <a id="pa-dab79d1253"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
