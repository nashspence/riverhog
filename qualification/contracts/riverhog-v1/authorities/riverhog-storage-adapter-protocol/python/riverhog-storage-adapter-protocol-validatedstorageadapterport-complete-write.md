...
- <a id="s-975febd8a8"></a>`kind`: `"method"`
- <a id="s-79ca271b70"></a>`signature`: `"\"(self, request: 'WriteCompleteRequest') -> 'CompletedObjectReceipt'\""`
...
- <a id="pa-fd6258bca3"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
