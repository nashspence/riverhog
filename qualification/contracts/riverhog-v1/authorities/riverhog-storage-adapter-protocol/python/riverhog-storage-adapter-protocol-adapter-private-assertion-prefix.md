...
- <a id="s-081a6cb805"></a>`kind`: `"constant"`
- <a id="s-fc3247be7e"></a>`value`: `"riverhog-adapter-"`

## Governing policies

- <a id="pa-eccbee5ed6"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
