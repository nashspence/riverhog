...
- <a id="s-abafecfd9a"></a>`kind`: `"property"`
- <a id="s-d95511cd3f"></a>`signature`: `"\"(self) -> 'Engine'\""`
...
- <a id="pa-ec752534ad"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
