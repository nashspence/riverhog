...
- <a id="s-e79085553f"></a>`kind`: `"constant"`
- <a id="s-f70857584f"></a>`value`: `"application/cloudevents+json"`

## Governing policies

- <a id="pa-c041d36a71"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
