...
| Family | [entry-point-extensions](index.md#f-5bea80b9f621) |
| Contract elements | 1 |
| Extent decisions | 0 |

## External contract

<a id="s-5ab5618c726e"></a>
| Field | Shape |
|---|---|
| <a id="s-08e91d604af6"></a>`group` | "stove0.observer-semantic-validators" |
| <a id="s-9fa68e11d3ae"></a>`owner` | "stove0-observer-client" |
| <a id="s-e35eaff2a990"></a>`owner_constant` | "SEMANTIC_VALIDATOR_ENTRY_POINT_GROUP" |
| <a id="s-996b6416972b"></a>`owner_path` | "reference/stove0/packages/observer-client" |
| <a id="s-066920e27bd9"></a>`providers` | items=additional keys=`distribution`, `name`, `value` \| additional keys=`distribution`, `name`, `value` |

## Governing policies

- <a id="pa-d16c9cf59ac1"></a>[boundary/frozen-authority/v1](../../../policies/index.md#p-61994d3f0fa8)
