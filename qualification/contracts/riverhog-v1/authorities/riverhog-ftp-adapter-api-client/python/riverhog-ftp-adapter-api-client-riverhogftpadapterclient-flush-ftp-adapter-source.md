...
- <a id="s-42484cb4e4"></a>`kind`: `"method"`
- <a id="s-60a73a23fe"></a>`signature`: `"\"(self, source_id: 'str') -> 'dict[str, Any]'\""`

## Maintained corroboration

### Related interface records

- [riverhog-ftp-adapter flush](../../riverhog-ftp-adapter/cli/riverhog-ftp-adapter-flush.md)
- [POST /v1/sources/{source_id}/flush](../../riverhog-ftp-adapter/http-operations/post-v1-sources-source-id-flush.md)
- [RiverhogFtpAdapterClient](riverhog-ftp-adapter-api-client-riverhogftpadapterclient.md)

## Governing policies

- <a id="pa-693990a21e"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
...
- **Client method:** [reference/riverhog/ingress/ftp-api-client/src/riverhog\_ftp\_adapter\_api\_client/client.py::RiverhogFtpAdapterClient.flush\_ftp\_adapter\_source](../../../../../../reference/riverhog/ingress/ftp-api-client/src/riverhog_ftp_adapter_api_client/client.py#L102)
