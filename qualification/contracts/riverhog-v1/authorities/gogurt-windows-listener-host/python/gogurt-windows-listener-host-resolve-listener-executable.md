...
- <a id="s-eaa9e9e120"></a>`kind`: `"function"`
- <a id="s-c53a60414a"></a>`signature`: `"\"(raw: 'str \| None' = None) -> 'Path'\""`

## Governing policies

- <a id="pa-2a2b06d75f"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
