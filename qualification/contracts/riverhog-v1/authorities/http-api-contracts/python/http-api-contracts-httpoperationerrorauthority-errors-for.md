...
- <a id="s-fb514ab8a3"></a>`kind`: `"method"`
- <a id="s-e3a3fcbf69"></a>`signature`: `"\"(self, operation_id: 'str') -> 'tuple[HttpErrorContract, ...]'\""`
...
- <a id="pa-78f68c817e"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
