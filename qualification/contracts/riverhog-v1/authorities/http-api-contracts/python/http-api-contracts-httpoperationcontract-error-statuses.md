...
- <a id="s-f848a5ad5c"></a>`kind`: `"property"`
- <a id="s-bdec70d3d3"></a>`signature`: `"\"(self) -> 'tuple[int, ...]'\""`
...
- <a id="pa-0252194400"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
