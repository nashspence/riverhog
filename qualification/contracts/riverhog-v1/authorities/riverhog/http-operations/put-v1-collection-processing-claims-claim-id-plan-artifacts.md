...
|---|---|---:|---|---|
| <a id="s-fd484d6634"></a>`claim_id` | path | yes | not declared | type="string"; pattern="^[0-9a-f]{64}$"; title="Claim Id" |
...
| <a id="s-e9dacd7f7f"></a>`400` | Bad Request | application/json | [ErrorOut](../http-schemas/schemas-errorout.md) | `bad_request` |
| <a id="s-a995f7e565"></a>`401` | Unauthorized | application/json | [ErrorOut](../http-schemas/schemas-errorout.md) | `unauthorized` |
| <a id="s-e1e71e4ec3"></a>`403` | Forbidden | application/json | [ErrorOut](../http-schemas/schemas-errorout.md) | `forbidden` |
| <a id="s-1cee784ef4"></a>`500` | Internal Server Error | application/json | [ErrorOut](../http-schemas/schemas-errorout.md) | `internal_error` |
...
- [riverhog_client.ApiClient.append_processing_claim_artifacts](../../riverhog-client/python/riverhog-client-apiclient-append-processing-claim-artifacts.md)
...
- <a id="pa-de554f927b"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
- <a id="pa-45e78eacbe"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
- **Handler:** [riverhog/src/riverhog\_api/routers/workflows.py::append\_processing\_claim\_artifacts](../../../../../../riverhog/src/riverhog_api/routers/workflows.py#L166)
...
<!-- exact-contract-value: a8c0a1ff31c797a3d4d6120ebe52f322acef0f278f869563faa0720423b88464 -->
