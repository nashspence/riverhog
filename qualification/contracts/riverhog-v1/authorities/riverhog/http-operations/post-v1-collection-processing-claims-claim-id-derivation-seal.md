...
|---|---|---:|---|---|
| <a id="s-0905f3c60f"></a>`claim_id` | path | yes | not declared | type="string"; pattern="^[0-9a-f]{64}$" |
...
- <a id="pa-2cc8121678"></a>[compatibility/http-api/v1](../../../policies/index.md#p-5bc717c2c0)
- <a id="pa-b400a5418a"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
...
- **Handler:** [riverhog/src/riverhog_api/routers/workflows.py::seal_processing_claim_dispositions](../../../../../../riverhog/src/riverhog_api/routers/workflows.py#L568)

**Accounting gap:** [riverhog_client.ApiClient.seal_processing_claim_dispositions](../../../../../../packages/riverhog-client/src/riverhog_client/workflows.py#L579) is callable through the maintained client but has no Python contract dossier in the current freeze.
