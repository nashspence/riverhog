...
|---|---|---|---|---|
| <a id="s-52c6a2aa5e"></a>`200` | Successful Response | application/json | [ArtifactReceivingSetDocument](../http-schemas/schemas-artifactreceivingsetdocument.md) | not declared |
| <a id="s-5e78616014"></a>`400` | Bad Request | application/json | [ErrorResponse](../http-schemas/schemas-errorresponse.md) | `bad_request` |
| <a id="s-c16d957b86"></a>`401` | Unauthorized | application/json | [ErrorResponse](../http-schemas/schemas-errorresponse.md) | `unauthorized` |
| <a id="s-148fc325be"></a>`403` | Forbidden | application/json | [ErrorResponse](../http-schemas/schemas-errorresponse.md) | `forbidden` |
| <a id="s-3c05b5acb7"></a>`500` | Internal Server Error | application/json | [ErrorResponse](../http-schemas/schemas-errorresponse.md) | `internal_error` |
...
- **Handler:** [riverhog/src/riverhog_api/routers/workflows.py::seal_transform_capability_artifacts](../../../../../../riverhog/src/riverhog_api/routers/workflows.py#L438)

**Accounting gap:** [riverhog_client.ApiClient.seal_transform_capability_artifacts](../../../../../../packages/riverhog-client/src/riverhog_client/workflows.py#L448) is callable through the maintained client but has no Python contract dossier in the current freeze.
