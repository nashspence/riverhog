...
| <a id="s-79db77eddc"></a>`created_at` | yes | anyOf=[(type="string"; maxLength=30; minLength=30; pattern="^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\\.[0-9]{9}Z$"); (type="null")]; title="Created At" |  |
...
| <a id="s-e51c2fae2e"></a>`orphaned_at` | yes | anyOf=[(type="string"; maxLength=30; minLength=30; pattern="^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\\.[0-9]{9}Z$"); (type="null")]; title="Orphaned At" |  |
...
| <a id="s-9142e69595"></a>`upload_state_expires_at` | yes | anyOf=[(type="string"; maxLength=30; minLength=30; pattern="^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\\.[0-9]{9}Z$"); (type="null")]; title="Upload State Expires At" |  |
...
| Applies to | Contract | Bounds or reason |
|---|---|---|
| <a id="s-ca906432fb"></a>[field created_at · string value](#s-79db77eddc) | `length · characters · fixed` | maximum=30; minimum=30; reason="fixed-public-representation" |
...
| <a id="s-de8672ee60"></a>[field orphaned_at · string value](#s-e51c2fae2e) | `length · characters · fixed` | maximum=30; minimum=30; reason="fixed-public-representation" |
...
| <a id="s-e83872b880"></a>[field upload_state_expires_at · string value](#s-9142e69595) | `length · characters · fixed` | maximum=30; minimum=30; reason="fixed-public-representation" |
...
- <a id="pa-6da5c1ff5c"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
- <a id="pa-b45767be95"></a>[extent-rule/no-semantic-maximum/v1](../../extent-contract/extent/extent-rule-no-semantic-maximum.md#p-574724b48a)
- <a id="pa-32d23f6108"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
<!-- exact-contract-value: cb25e93f46d924426352a3db6e88b6e43190e3719a5d68ede103c67df0a5b4b6 -->
