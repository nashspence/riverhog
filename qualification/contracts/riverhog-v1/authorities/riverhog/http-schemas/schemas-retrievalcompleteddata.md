...
| <a id="s-a2fc38c4b7"></a>`collection_created_at` | no | anyOf=[(type="string"; maxLength=30; minLength=30; pattern="^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\\.[0-9]{9}Z$"); (type="null")]; title="Collection Created At" |  |
...
| Applies to | Contract | Bounds or reason |
|---|---|---|
| <a id="s-650fc1ef83"></a>[field collection_created_at · string value](#s-a2fc38c4b7) | `length · characters · fixed` | maximum=30; minimum=30; reason="fixed-public-representation" |
...
<!-- exact-contract-value: 473a15b028838e1972d908c19c031866887c2a01771880cb22b5e52f88e185a0 -->
