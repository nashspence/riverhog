...
<!-- contract-element: http-schemas:riverhog:schemas-failedarchivecopyout:0fbdbe0db2 -->
...
- <a id="s-2faa30c325"></a>`additionalProperties`: `false`
- <a id="s-b9881b2aaf"></a>`required`: `["store","storage_prefix","object_count","stored_bytes","last_uploaded_at","last_verified_at","archive_root","state","failure"]`
...
- <a id="pa-c207ddc641"></a>[compatibility/http-api/v1](../../../policies/index.md#p-5bc717c2c0)
