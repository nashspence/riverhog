...
<!-- contract-element: http-schemas:riverhog:schemas-applicationaccessgrantset:bbef31b8b2 -->
...
|---|---|---|
| [schemas: ApplicationAccessGrantSet](#s-0f785b069a) | `cardinality · items · operational_policy` | shared above |
...
- <a id="pa-becfb6cda9"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
- <a id="pa-91c21de56a"></a>[extent-rule/no-semantic-maximum/v1](../../extent-contract/extent/extent-rule-no-semantic-maximum.md#p-574724b48a)
- <a id="pa-d955078dac"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
