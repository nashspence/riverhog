...
<!-- contract-element: http-schemas:riverhog:schemas-keydownloadquotalistout:59c6d83a65 -->
...
|---|---|---|
| [field quotas](#s-3326d2ce08) | `cardinality · items · segmented_no_total_max` | shared above |
...
| Applies to | Contract | Bounds or reason |
|---|---|---|
| [field page_size](#s-ea9fc70dca) | `value · schema-value · contract_max` | shared above |
...
- <a id="pa-939a9523b6"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
- <a id="pa-3e429412f8"></a>[extent-rule/route-progression/v1](../../extent-contract/extent/extent-rule-route-progression.md#p-6b76b527cb)
- <a id="pa-c8e223989e"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
