...
<!-- contract-element: http-schemas:riverhog:schemas-processingoutcomeidentitydocument:596b93d3e3 -->
...
- <a id="s-db3623815e"></a>`additionalProperties`: `false`
- <a id="s-6534dcfa47"></a>`required`: `["outcome_id","source_claim_id","output_collection","derivation_sha256"]`
...
- <a id="pa-cc0d50048f"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
- <a id="pa-1fb89eb873"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
