...
<!-- contract-element: http-schemas:riverhog:schemas-listcollectionuploadsessionsresponse:fb3992026c -->
...
|---|---:|---|---|
| <a id="s-d2ea9c3cc3"></a>`filters` | yes | [CollectionUploadListFiltersOut](schemas-collectionuploadlistfiltersout.md) |  |
| <a id="s-849c5a09ca"></a>`next_page_token` | yes | anyOf=[([BrowsePageToken](schemas-browsepagetoken.md)); (type="null")] |  |
| <a id="s-3c8c0c69e9"></a>`order` | yes | [SortOrder](schemas-sortorder.md) |  |
| <a id="s-5f8d2ec911"></a>`page_size` | yes | type="integer"; minimum=1; maximum=100; title="Page Size" |  |
| <a id="s-80d2dee606"></a>`query` | yes | anyOf=[(type="string"); (type="null")]; title="Query" |  |
| <a id="s-61648fd94b"></a>`sort` | yes | [CollectionUploadSort](schemas-collectionuploadsort.md) |  |
| <a id="s-b2370a9c91"></a>`uploads` | yes | type="array"; items=([CollectionUploadListItemOut](schemas-collectionuploadlistitemout.md)); title="Uploads" |  |
...
- <a id="pa-74ff6c3101"></a>[compatibility/http-api/v1](../../release/compatibility-guarantees/compatibility-http-api.md#p-5bc717c2c0)
- <a id="pa-1e7c3801df"></a>[extent-rule/route-progression/v1](../../extent-contract/extent/extent-rule-route-progression.md#p-6b76b527cb)
- <a id="pa-0dad561f82"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
