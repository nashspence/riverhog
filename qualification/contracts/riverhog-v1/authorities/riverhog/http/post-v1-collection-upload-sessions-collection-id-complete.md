...
<a id="s-bba87c22e22b"></a>
- <a id="s-20f89302aa15"></a>`operationId`: complete_collection_upload_session
- <a id="s-f5db6d24d984"></a>`summary`: Complete Collection Upload Session
- <a id="s-236b09a3c418"></a>`security`: `[{"HTTPBearer": []}]`

### Parameters

| Name | In | Required | Schema |
|---|---|---:|---|
| <a id="s-8c053756f360"></a>`collection_id` | path | yes | type="integer"; minimum=1 |

### Responses

| Status | Description |
|---|---|
| <a id="s-d2e6036799e7"></a>`200` | Successful Response |
| <a id="s-8cf88ecbee57"></a>`400` | Bad Request |
| <a id="s-f753012399a5"></a>`401` | Unauthorized |
| <a id="s-5661ca887e20"></a>`403` | Forbidden |
| <a id="s-5f12ce77c945"></a>`404` | Not Found |
| <a id="s-d0376f6b2aba"></a>`409` | Conflict |
| <a id="s-fe1c86ac4df9"></a>`500` | Internal Server Error |
...
- <a id="pa-f511b1876325"></a>[compatibility/http-api/v1](../../../policies/index.md#p-5bc717c2c0ba)
