...
|---|---|---:|---|
| <a id="s-2c5a34b5e0"></a>`claim_id` | path | yes | type="string"; pattern="^[0-9a-f]{64}$" |
...
| Status | Description |
|---|---|
| <a id="s-1ce07523dc"></a>`200` | Successful Response |
| <a id="s-09260ac7eb"></a>`400` | Bad Request |
| <a id="s-0e67591ad0"></a>`401` | Unauthorized |
| <a id="s-86ea45f3f0"></a>`403` | Forbidden |
| <a id="s-2aa283f336"></a>`404` | Not Found |
| <a id="s-6dfe5d4ad7"></a>`409` | Conflict |
| <a id="s-cee60c8270"></a>`500` | Internal Server Error |
...
- <a id="pa-b2a79a178b"></a>[compatibility/http-api/v1](../../../policies/index.md#p-5bc717c2c0)
- <a id="pa-b4c469006d"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
