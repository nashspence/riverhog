...
<a id="s-8a60d61b30ca"></a>
- <a id="s-46aa0a8a0c13"></a>`title`: ProvenanceTraceExternalStateReferenceItemOut
- <a id="s-63e947ccd800"></a>`type`: object

### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-82c2fe1e31d9"></a>`kind` | yes | type="string"; const="external_state_reference" |  |
| <a id="s-ac9f21d08d67"></a>`reference` | yes | #/components/schemas/ProvenanceExternalStateReferenceOut |  |
...
- <a id="pa-67af2420fbb7"></a>[compatibility/http-api/v1](../../../policies/index.md#p-5bc717c2c0ba)
