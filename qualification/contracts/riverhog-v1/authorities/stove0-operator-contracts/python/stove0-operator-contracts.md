...
<!-- contract-element: python:stove0-operator-contracts:stove0-operator-contracts:2b65cb96ac -->
...
- `/external_contract/python/44`

### Exact owned JSON

The following JSON is the complete value owned at each machine-authority pointer. No contractual fields are summarized away.

<!-- exact-contract-value: 9399a3522f3e5593d60300421db87e3f3f183fa28babeba049cb0aaa458e0a12 -->

```json
{
  "candidate_id": "python:stove0-operator-contracts:stove0_operator_contracts",
