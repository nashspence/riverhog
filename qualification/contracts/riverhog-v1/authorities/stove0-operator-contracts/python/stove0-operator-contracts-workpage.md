...
- [CollectionRootIdentityRef](#s-af69acd5dd)
- [ContentObservationEvidence](#s-9057c722fc)
- [ContentObservationFailure](#s-ba83b01d61)
- [ContentObservationInapplicable](#s-f306a50c88)
- [ContentObservationRequest](#s-14df9aaa03)
- [ContentObservationResult](#s-65358bbe1a)
...
- [DeclaredWorkspaceProtection](#s-57c5bbdee5)
...
- [JsonSchemaValidationProfile](#s-3a20727452)
- [JsonValue](#s-e69ffb8f42)
- [NonnegativeDecimal](#s-8018585049)
- [ObserverImplementation](#s-4ea959a8e4)
- [OperationIdentityRef](#s-fbe284576e)
...
- [RecipeIdentityRef](#s-6a337db3c7)
...
- [WorkArtifactSubject](#s-4cd993b6f8)
...
| <a id="s-bf2317f217"></a>`total_bytes` | yes | [NonnegativeDecimal](#s-8018585049); ge=0 |  |
...
| <a id="s-97d9c359af"></a>`source_collection_retirement_grace_seconds` | no | type="integer"; minimum=0; default=0 |  |
| <a id="s-dc6bdcdb99"></a>`source_collection_retirement_policy` | no | type="string"; enum=["retain","retire-after-verified-output"]; default="retain" |  |
...
| Alternative | Schema |
|---|---|
| <a id="s-1c190509b8"></a>1 | type="string"; pattern="^(?:0\|[1-9][0-9]{0,17}\|[1-8][0-9]{18}\|9[0-1][0-9]{17}\|92[0-1][0-9]{16}\|922[0-2][0-9]{15}\|9223[0-2][0-9]{14}\|92233[0-6][0-9]{13}\|922337[0-1][0-9]{12}\|92233720[0-2][0-9]{10}\|922337203[0-5][0-9]{9}\|9223372036[0-7][0-9]{8}\|92233720368[0-4][0-9]{7}\|922337203685[0-3][0-9]{6}\|9223372036854[0-6][0-9]{5}\|92233720368547[0-6][0-9]{4}\|922337203685477[0-4][0-9]{3}\|9223372036854775[0-7][0-9]{2}\|922337203685477580[0-6][0-9]{0}\|9223372036854775807)(?![\\s\\S])" |
| <a id="s-432ce08c17"></a>2 | not=(const="0") |

##### <a id="s-af69acd5dd"></a>definition `CollectionRootIdentityRef`

- <a id="s-b33b92d749"></a>`type`: `"object"`
- <a id="s-d323da6098"></a>`additionalProperties`: `false`
- <a id="s-812e7a67c3"></a>`required`: `["collection_id","archive_root_sha256","content_identity"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-37ca1bf48f"></a>`archive_root_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-81e25f378d"></a>`collection_id` | yes | [CollectionId](#s-1d96dcbbf7) |  |
| <a id="s-54fbbee41b"></a>`content_identity` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |

##### <a id="s-9057c722fc"></a>definition `ContentObservationEvidence`

- <a id="s-46383903b6"></a>`type`: `"object"`
- <a id="s-adaccfe38a"></a>`additionalProperties`: `false`
- <a id="s-2c05be59e5"></a>`required`: `["request","result"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-38044c32ba"></a>`request` | yes | [ContentObservationRequest](#s-14df9aaa03) |  |
| <a id="s-f4e9f9e4d0"></a>`result` | yes | [ContentObservationResult](#s-65358bbe1a) |  |

##### <a id="s-ba83b01d61"></a>definition `ContentObservationFailure`

- <a id="s-e7f1da0ddd"></a>`type`: `"object"`
- <a id="s-0e4e2d5f86"></a>`additionalProperties`: `false`
- <a id="s-396f81db9e"></a>`required`: `["code","message","retryable"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-70dc8bdbb7"></a>`code` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-295f52cfce"></a>`message` | yes | type="string"; maxLength=1000; minLength=1 |  |
| <a id="s-b0eb891bf3"></a>`retryable` | yes | type="boolean" |  |

##### <a id="s-f306a50c88"></a>definition `ContentObservationInapplicable`

- <a id="s-f86a42edea"></a>`type`: `"object"`
- <a id="s-4eb0d4ff51"></a>`additionalProperties`: `false`
- <a id="s-605c2e4951"></a>`required`: `["code","message"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-093af3ee76"></a>`code` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-7fdada4b53"></a>`message` | yes | type="string"; maxLength=1000; minLength=1 |  |

##### <a id="s-14df9aaa03"></a>definition `ContentObservationRequest`

- <a id="s-51184d71a1"></a>`type`: `"object"`
- <a id="s-bc7e0d1618"></a>`additionalProperties`: `false`
- <a id="s-ebae1503f1"></a>`required`: `["work_id","observer_registration_id","observer_descriptor_sha256","observer_contract_id","observer_contract_sha256","subjects","request_id"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-49587a594b"></a>`format` | no | type="string"; const="stove0-observation-request/v1"; default="stove0-observation-request/v1" |  |
| <a id="s-a60e7478ff"></a>`maximum_result_bytes` | no | type="integer"; minimum=1; maximum=67108864; default=1048576 |  |
| <a id="s-90a85b543b"></a>`observer_contract_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-ed36bba532"></a>`observer_contract_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-41e5fe931d"></a>`observer_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-eb1255bf41"></a>`observer_registration_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9.-]{0,118}[a-z0-9])?$" |  |
| <a id="s-e38a590e5c"></a>`options` | no | type="object"; additionalProperties=([JsonValue](#s-e69ffb8f42)) |  |
| <a id="s-a2675e7822"></a>`request_id` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-c6cb00feae"></a>`retrieval_policy` | no | type="string"; enum=["available-only","allow"]; default="available-only" |  |
| <a id="s-4e052dfa9e"></a>`subjects` | yes | type="array"; items=([WorkArtifactSubject](#s-4cd993b6f8)); minItems=1 |  |
| <a id="s-ecfda147d6"></a>`timeout_seconds` | no | type="integer"; minimum=1; maximum=86400; default=300 |  |
| <a id="s-1e9611595f"></a>`work_id` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |

##### <a id="s-65358bbe1a"></a>definition `ContentObservationResult`

- <a id="s-7c97ec6078"></a>`type`: `"object"`
- <a id="s-83a4f28f8d"></a>`additionalProperties`: `false`
- <a id="s-cb6b96fd56"></a>`required`: `["request_id","state","observer","observer_contract_id","observer_contract_sha256","subjects","result_sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-4588f0afe1"></a>`execution_evidence` | no | type="object"; additionalProperties=([JsonValue](#s-e69ffb8f42)) |  |
| <a id="s-b7dfffb3ee"></a>`facts` | no | anyOf=[(type="object"; additionalProperties=([JsonValue](#s-e69ffb8f42))); (type="null")]; default=null |  |
| <a id="s-d8af1f0851"></a>`facts_schema` | no | anyOf=[([JsonSchemaValidationProfile](#s-3a20727452)); (type="null")]; default=null |  |
| <a id="s-a81319676f"></a>`facts_sha256` | no | anyOf=[(type="string"; pattern="^[0-9a-f]{64}$"); (type="null")]; default=null |  |
| <a id="s-92a96934ce"></a>`failure` | no | anyOf=[([ContentObservationFailure](#s-ba83b01d61)); (type="null")]; default=null |  |
| <a id="s-e148af9074"></a>`format` | no | type="string"; const="stove0-observation-result/v1"; default="stove0-observation-result/v1" |  |
| <a id="s-1f6b157bdf"></a>`inapplicable` | no | anyOf=[([ContentObservationInapplicable](#s-f306a50c88)); (type="null")]; default=null |  |
| <a id="s-21151f6c25"></a>`observer` | yes | [ObserverImplementation](#s-4ea959a8e4) |  |
| <a id="s-43a7ff585f"></a>`observer_contract_id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-89f6e8cb48"></a>`observer_contract_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-42b5015cfa"></a>`request_id` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-1a76b6350f"></a>`result_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-59d298efc8"></a>`state` | yes | type="string"; enum=["observed","inapplicable","failed","canceled"] |  |
| <a id="s-b05701483a"></a>`subjects` | yes | type="array"; items=([WorkArtifactSubject](#s-4cd993b6f8)); minItems=1 |  |
...
| <a id="s-7f1eb4e474"></a>`output_collection` | yes | [CollectionRootIdentityRef](#s-af69acd5dd) |  |
...
##### <a id="s-57c5bbdee5"></a>definition `DeclaredWorkspaceProtection`

- <a id="s-cb135145b2"></a>`type`: `"string"`
- <a id="s-66b6e92e12"></a>`enum`: `["encrypted-at-rest","memory-backed"]`

##### <a id="s-40282e1d49"></a>definition `EffectPlan`

- <a id="s-219845a237"></a>`type`: `"object"`
- <a id="s-f7e2954897"></a>`additionalProperties`: `false`
- <a id="s-b71da421ff"></a>`required`: `["operation_id","operation_contract_sha256","inputs","intent","target_implementation_id","target_descriptor_sha256","plan_sha256"]`
...
| <a id="s-f8115eca16"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="s-8f65c64444"></a>`required`: `["job_id","request_sha256","target_descriptor_sha256","operation_contract_sha256","plan_sha256","execution_sha256","result","receipt_sha256"]`
...
| <a id="s-e9fe247f47"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
| <a id="s-f8c5c82747"></a>`recipe` | yes | [RecipeIdentityRef](#s-6a337db3c7) |  |
...
| <a id="s-395114ca37"></a>`output_collection` | yes | [CollectionRootIdentityRef](#s-af69acd5dd) |  |
...
##### <a id="s-3a20727452"></a>definition `JsonSchemaValidationProfile`

- <a id="s-aebf71af8c"></a>`type`: `"object"`
- <a id="s-92820d63af"></a>`additionalProperties`: `false`
- <a id="s-045d963a94"></a>`required`: `["id","profile_sha256","schema"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-96acc1cb82"></a>`dialect` | no | type="string"; const="https://json-schema.org/draft/2020-12/schema"; default="https://json-schema.org/draft/2020-12/schema" |  |
| <a id="s-baaa415858"></a>`format_policy` | no | type="string"; const="annotation-only"; default="annotation-only" |  |
| <a id="s-87cd6409e2"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-163f31fda3"></a>`profile_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
| <a id="s-bde03a2df1"></a>`schema` | yes | type="object"; additionalProperties=([JsonValue](#s-e69ffb8f42)) |  |

##### <a id="s-e69ffb8f42"></a>definition `JsonValue`

- Accepts: any JSON value.

##### <a id="s-8018585049"></a>definition `NonnegativeDecimal`

- <a id="s-57975a3c7e"></a>`type`: `"string"`
- <a id="s-752cc18828"></a>`pattern`: `"^(?:0\|[1-9][0-9]*)(?![\\s\\S])"`
...
##### <a id="s-fbe284576e"></a>definition `OperationIdentityRef`

- <a id="s-1db03c7a98"></a>`type`: `"object"`
- <a id="s-8967dcec9a"></a>`additionalProperties`: `false`
- <a id="s-77748c2bd0"></a>`required`: `["id","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-df36e8c9be"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-a5b7ca365f"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
| <a id="s-d235ba771e"></a>`total_bytes` | yes | [NonnegativeDecimal](#s-8018585049); ge=0 |  |
...
##### <a id="s-6a337db3c7"></a>definition `RecipeIdentityRef`

- <a id="s-88d31b1208"></a>`type`: `"object"`
- <a id="s-0c6a774eb5"></a>`additionalProperties`: `false`
- <a id="s-61f8dc6861"></a>`required`: `["id","revision","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-30e09c2aa8"></a>`id` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-7ec29afd87"></a>`revision` | yes | [NonnegativeDecimal](#s-8018585049); ge=1 |  |
| <a id="s-74de00e4d0"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="s-18667bff80"></a>`required`: `["target_descriptor_sha256","operation_contract_sha256","plan_sha256","execution_sha256"]`
...
| <a id="s-88fe1e89c0"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="s-ddc48eb58f"></a>`required`: `["job_id","claim_id","fence","controller_evidence","plan","declared_workspace_protection"]`
...
| <a id="s-fb58517b95"></a>`declared_workspace_protection` | yes | [DeclaredWorkspaceProtection](#s-57c5bbdee5) |  |
...
| <a id="s-5cf4fc0d40"></a>`total_bytes` | yes | [NonnegativeDecimal](#s-8018585049); ge=0 |  |
...
- <a id="s-7cf3500f2b"></a>`required`: `["protocol","target_implementation_id","target_descriptor_sha256","operation_contract_sha256","plan","plan_sha256"]`
...
| <a id="s-99d69b4177"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="s-b63506d21c"></a>`required`: `["operation_id","operation_contract_sha256","inputs","intent","target_implementation_id","target_descriptor_sha256","plan_sha256"]`
...
| <a id="s-4cd061ad4b"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
##### <a id="s-4cd993b6f8"></a>definition `WorkArtifactSubject`

- <a id="s-a15efa3807"></a>`type`: `"object"`
- <a id="s-2e9fb570aa"></a>`additionalProperties`: `false`
- <a id="s-fc3f7e2081"></a>`required`: `["id","role","collection","path","bytes","sha256"]`

###### Fields

| Field | Required | Shape | Description |
|---|---:|---|---|
| <a id="s-83938e94a5"></a>`bytes` | yes | [NonnegativeDecimal](#s-8018585049); ge=0 |  |
| <a id="s-656b170201"></a>`collection` | yes | [CollectionRootIdentityRef](#s-af69acd5dd) |  |
| <a id="s-2a9ed89e4f"></a>`id` | yes | type="string"; pattern="^[A-Za-z0-9]&#40;?:[A-Za-z0-9._-]{0,158}[A-Za-z0-9])?$" |  |
| <a id="s-ccad43b2fd"></a>`media_type` | no | anyOf=[(type="string"; maxLength=255; minLength=1); (type="null")]; default=null |  |
| <a id="s-ae864e0fdd"></a>`path` | yes | type="string"; maxLength=4096; minLength=1 |  |
| <a id="s-1a7ff950da"></a>`role` | yes | type="string"; pattern="^[a-z0-9]&#40;?:[a-z0-9._/-]{0,158}[a-z0-9])?$" |  |
| <a id="s-ccbee8462b"></a>`sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
| <a id="s-ae142c547a"></a>`inputs` | yes | type="array"; items=([CollectionRootIdentityRef](#s-af69acd5dd)); minItems=1 |  |
| <a id="s-9aa8342902"></a>`recipe` | yes | [RecipeIdentityRef](#s-6a337db3c7) |  |
...
| <a id="s-7f980af1d8"></a>`observation_requests` | no | type="array"; default=[]; items=([ContentObservationRequest](#s-14df9aaa03)) |  |
| <a id="s-45475212e2"></a>`observation_results` | no | type="array"; default=[]; items=([ContentObservationResult](#s-65358bbe1a)) |  |
| <a id="s-cd1f16e43c"></a>`output` | no | anyOf=[([OutputCollectionRef](#s-b5248b631f)); (type="null")]; default=null |  |
| <a id="s-1906fb3340"></a>`phase` | yes | type="string"; enum=["eligible","claimed","observing","planning","target_preflight","queued","executing","output_finalizing","verifying","settled","source_collection_retirement_pending","coordinating","abandon_pending","complete","inapplicable","failed","canceled"] |  |
...
| <a id="s-5cad3b2c09"></a>`source_collection_retirement_remaining` | no | type="array"; default=[]; items=(type="integer") |  |
...
- <a id="s-61259067d4"></a>`required`: `["work","operation","target_registration_id","target_descriptor_sha256","workflow_plan_sha256"]`
...
| <a id="s-4b96392b74"></a>`observations` | no | type="array"; default=[]; items=([ContentObservationEvidence](#s-9057c722fc)) |  |
| <a id="s-8ada58129f"></a>`operation` | yes | [OperationIdentityRef](#s-fbe284576e) |  |
...
| <a id="s-af3b9fc676"></a>`source_collection_retirement_grace_seconds` | no | type="integer"; minimum=0; default=0 |  |
| <a id="s-cadfe39212"></a>`source_collection_retirement_policy` | no | type="string"; enum=["retain","retire-after-verified-output"]; default="retain" |  |
| <a id="s-0f4b41ac9a"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="s-fcabfbcf61"></a>`required`: `["operation","target_registration_id","target_descriptor_sha256"]`
...
| <a id="s-1559d130af"></a>`operation` | yes | [OperationIdentityRef](#s-fbe284576e) |  |
...
| <a id="s-a542f5a5ce"></a>`source_collection_retirement_grace_seconds` | no | type="integer"; minimum=0; default=0 |  |
| <a id="s-fb545d1c79"></a>`source_collection_retirement_policy` | no | type="string"; enum=["retain","retire-after-verified-output"]; default="retain" |  |
| <a id="s-55531bd318"></a>`target_descriptor_sha256` | yes | type="string"; pattern="^[0-9a-f]{64}$" |  |
...
- <a id="pa-3c28a21596"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
...
<!-- exact-contract-value: 024a568c9b7048296abecb83b04dea14e99627a3a90017470461cf578a128aea -->
