...
- <a id="s-67f2d59552"></a>`kind`: `"method"`
- <a id="s-3d9c93e729"></a>`signature`: `"\"(self, chunk_index: 'int', ciphertext: 'bytes', *, final: 'bool') -> 'bytes'\""`
...
- <a id="pa-4770f23533"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
