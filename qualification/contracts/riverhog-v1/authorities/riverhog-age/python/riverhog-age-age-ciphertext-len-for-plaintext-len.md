...
- <a id="s-df0f3de41b"></a>`kind`: `"function"`
- <a id="s-0606c2c431"></a>`signature`: `"\"(plaintext_size: 'int', *, age_prefix_len: 'int') -> 'int'\""`

## Governing policies

- <a id="pa-c5c4b90fe2"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
