...
- <a id="pa-42014c1275"></a>[compatibility/configuration/v1](../../../policies/index.md#p-8dc08bb461)
...
- [configuration-environment:stove0-review-materialize-target:STOVE0_REVIEW_MATERIALIZE_TARGET_SAMPLERS_JSON_FILE](../../../evidence/sources.md#src-0f35eb76bc) — `reference/stove0/targets/review/materialize-target/src/stove0_review_materialize_target/app.py`
...
|---|---|---|---|
| parser | `stove0-review-materialize-target` | `reference/stove0/targets/review/materialize-target/src/stove0_review_materialize_target/app.py` | `os.getenv(f'{PREFIX}_SAMPLERS_JSON_FILE')` |
