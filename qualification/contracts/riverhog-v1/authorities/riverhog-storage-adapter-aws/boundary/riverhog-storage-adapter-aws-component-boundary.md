...
| Field | Shape |
|---|---|
| `console_scripts` | additional keys=`riverhog-storage-adapter-aws` |
| `dependencies` | ["riverhog-storage-adapter-asgi-support","riverhog-storage-adapter-protocol","riverhog-storage-adapter-s3-support","time-formats"] |
