...
- <a id="s-e6924935c0"></a>`kind`: `"object"`
- <a id="s-d49003ea84"></a>`type`: `"typing._AnnotatedAlias"`

## Governing policies

- <a id="pa-651cf2f4cd"></a>[compatibility/python-api/v1](../../release/compatibility-guarantees/compatibility-python-api.md#p-e574772ba5)
