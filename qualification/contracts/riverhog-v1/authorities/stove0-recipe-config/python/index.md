...
- [ArtifactFactBinding](stove0-recipe-config-artifactfactbinding.md)
- [ArtifactRule](stove0-recipe-config-artifactrule.md)
- [FactPredicate](stove0-recipe-config-factpredicate.md)
  - [valid_scope](stove0-recipe-config-factpredicate-valid-scope.md)
- [ObserverUse](stove0-recipe-config-observeruse.md)
- [OperationProjection](stove0-recipe-config-operationprojection.md)
- [RecipeBranch](stove0-recipe-config-recipebranch.md)
