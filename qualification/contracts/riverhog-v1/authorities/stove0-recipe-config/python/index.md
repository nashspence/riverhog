...
- [stove0_recipe_config.ArtifactFactBinding](stove0-recipe-config-artifactfactbinding.md)
- [stove0_recipe_config.ArtifactRule](stove0-recipe-config-artifactrule.md)
...
- [stove0_recipe_config.ObserverUse](stove0-recipe-config-observeruse.md)
- [stove0_recipe_config.OperationProjection](stove0-recipe-config-operationprojection.md)
- [stove0_recipe_config.RecipeBranch](stove0-recipe-config-recipebranch.md)
