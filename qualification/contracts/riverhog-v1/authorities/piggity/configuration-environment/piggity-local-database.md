...
- <a id="pa-7fb49c701f"></a>[compatibility/configuration/v1](../../release/compatibility-guarantees/compatibility-configuration.md#p-8dc08bb461)
...
- [configuration-environment:piggity:PIGGITY_LOCAL_DATABASE](../../../evidence/sources/authorities.md#src-ab1d0074de) — [reference/riverhog/applications/piggity/src/piggity/local.py::\_database](../../../../../../reference/riverhog/applications/piggity/src/piggity/local.py)
...
|---|---|---|---|
| parser | `piggity` | [reference/riverhog/applications/piggity/src/piggity/local.py](../../../../../../reference/riverhog/applications/piggity/src/piggity/local.py) | `os.getenv('PIGGITY_LOCAL_DATABASE', '')` |
