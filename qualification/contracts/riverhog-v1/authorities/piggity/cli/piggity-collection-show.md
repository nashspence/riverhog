...
|---|---|---|---|
| <a id="s-c9248428f9"></a>`collection`<br>`collection` | required positional; 1 value | integer | not recorded |
| <a id="s-29a6dc6d91"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
