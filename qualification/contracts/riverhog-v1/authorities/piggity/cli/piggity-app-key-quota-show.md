...
<!-- contract-element: cli:piggity:piggity-app-key-quota-show:39117f15a8 -->
...
- <a id="s-c9682a0d7a"></a>Extra arguments at this parser: rejected.
- <a id="s-c1bb3ab7f7"></a>Options after positional arguments at this parser: parsed as options.
- <a id="s-d6b5d4a28c"></a>Unknown options at this parser: rejected.
...
|---|---|---|---|
| <a id="s-a2059db178"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false`<br>Env: `null` |
...
|---|---|---|---|---|
| <a id="s-257875ff67"></a>`completed` | <a id="s-cd0a9493a9"></a>`{"kind":"command-completed"}` | <a id="s-7197715aaa"></a>`0` | <a id="s-2996f3ed91"></a>human: `"noncontractual-presentation-of-command-result"`; json: [HTTP get_download_quota response 200](../../riverhog/http-operations/get-v1-download-quota.md#s-0b2951931e) | <a id="s-6b9f7347b3"></a>all: `"empty"` |
...
| <a id="s-0ca72af393"></a>`operational` | <a id="s-66b576b507"></a>`{"kind":"application-error"}` | <a id="s-db55a96afe"></a>`1` | <a id="s-e07019c506"></a>human: `"empty"`; json: [http-api-contracts.ErrorResponse](../../http-api-contracts/python/http-api-contracts-errorresponse.md) | <a id="s-cdb6c5f081"></a>human: `"noncontractual-diagnostic"`; json: `"empty"` |
...
- <a id="pa-98fa19b358"></a>[compatibility/cli/v1](../../release/compatibility-guarantees/compatibility-cli.md#p-48a89776de)
- <a id="pa-3de6dca84b"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
- `/external_contract/cli/piggity/commands/app/commands/key/commands/quota/commands/show/allow_extra_args`
- `/external_contract/cli/piggity/commands/app/commands/key/commands/quota/commands/show/allow_interspersed_args`
- `/external_contract/cli/piggity/commands/app/commands/key/commands/quota/commands/show/ignore_unknown_options`
