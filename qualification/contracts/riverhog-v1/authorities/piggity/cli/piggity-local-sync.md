...
- <a id="s-d3e6816cedfa"></a>Parser name: `sync`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-6368e8bf418c"></a>`wait` | TyperOption | no | {'class': 'typer._click.types.BoolParamType', 'name': 'boolean'} | --wait |
| <a id="s-78b95fe0d71e"></a>`restore_policy` | TyperOption | no | {'class': 'typer._click.types.StringParamType', 'name': 'text'} | --restore-policy |
| <a id="s-b7ec88d2f597"></a>`json_mode` | TyperOption | no | {'class': 'typer._click.types.BoolParamType', 'name': 'boolean'} | --json |
...
|---|---|---|
| [CLI parameter --json](#s-b7ec88d2f597) | `cardinality · values-per-occurrence · fixed` | shared above |
| [CLI parameter --restore-policy](#s-78b95fe0d71e) | `cardinality · values-per-occurrence · fixed` | shared above |
| [CLI parameter --wait](#s-6368e8bf418c) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-d9ec8c06fedd"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-d0ac48e20d8b"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
