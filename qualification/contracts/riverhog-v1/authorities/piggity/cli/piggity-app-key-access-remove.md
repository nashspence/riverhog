...
|---|---|---|---|
| <a id="s-ca1077ee91"></a>`selector`<br>`selector` | required positional; 1 value | text | not recorded |
| <a id="s-12ddc39a1c"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
...
- <a id="pa-c00ba93760"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de)
- <a id="pa-a1e7f9db7f"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
