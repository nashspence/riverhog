...
- <a id="s-c3016d500e31"></a>Parser name: `remove`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-ca1077ee91ac"></a>`selector` | TyperArgument | yes | {'class': 'typer._click.types.StringParamType', 'name': 'text'} | selector |
| <a id="s-12ddc39a1c0c"></a>`json_mode` | TyperOption | no | {'class': 'typer._click.types.BoolParamType', 'name': 'boolean'} | --json |
...
|---|---|---|
| [CLI parameter --json](#s-12ddc39a1c0c) | `cardinality · values-per-occurrence · fixed` | shared above |
| [CLI parameter selector](#s-ca1077ee91ac) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-61a989c6fbc5"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-464d7c90316a"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
