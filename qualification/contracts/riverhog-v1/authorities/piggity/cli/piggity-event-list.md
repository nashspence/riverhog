...
|---|---|---|---|
| <a id="s-9b6e165302"></a>`after`<br>`--after` | optional option; 1 value | text | not recorded<br>Env: `null` |
| <a id="s-694707cea7"></a>`limit`<br>`--limit` | optional option; 1 value | integer range; minimum=`1` (inclusive); maximum=`100` (inclusive); outside range: reject | `100`<br>Env: `null` |
| <a id="s-c9e9de4469"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false`<br>Env: `null` |
...
- <a id="pa-ff78854f85"></a>[compatibility/cli/v1](../../release/compatibility-guarantees/compatibility-cli.md#p-48a89776de)
- <a id="pa-85004b1586"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
- **Command callback:** [reference/riverhog/applications/piggity/src/piggity/main.py::event\_list\_cmd](../../../../../../reference/riverhog/applications/piggity/src/piggity/main.py#L751)
