...
- <a id="s-cd2252804cb8"></a>Parser name: `status`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-fffd71beac49"></a>`json_mode` | TyperOption | no | {'class': 'typer._click.types.BoolParamType', 'name': 'boolean'} | --json |
...
|---|---|---|
| [CLI parameter --json](#s-fffd71beac49) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-9c03f9486529"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-ed83a4fe8d9f"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
