...
|---|---|---|---|
| <a id="s-b81c26e798"></a>`cursor`<br>`--cursor` | required option; 1 value | text | not recorded<br>Env: `null` |
| <a id="s-5596b60bf3"></a>`limit`<br>`--limit` | optional option; 1 value | integer range; minimum=`1` (inclusive); maximum=`100` (inclusive); outside range: reject | `100`<br>Env: `null` |
| <a id="s-ad19e2621a"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false`<br>Env: `null` |
...
- <a id="pa-23408f750a"></a>[compatibility/cli/v1](../../release/compatibility-guarantees/compatibility-cli.md#p-48a89776de)
- <a id="pa-096ed91a7d"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
- **Command callback:** [reference/riverhog/applications/piggity/src/piggity/main.py::catalog\_sync\_changes\_cmd](../../../../../../reference/riverhog/applications/piggity/src/piggity/main.py#L813)
