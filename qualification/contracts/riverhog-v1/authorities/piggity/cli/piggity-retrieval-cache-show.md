...
|---|---|---|---|---|
| <a id="s-8822d481ea"></a>`completed` | <a id="s-566e922e18"></a>`{"kind":"command-completed"}` | <a id="s-02040998ad"></a>`0` | <a id="s-2afc0f396d"></a>`human: noncontractual-presentation-of-command-result; json: HTTP get_retrieval_cache_object — #/components/schemas/RetrievalCacheObjectOut` | <a id="s-97a926ae57"></a>`all: empty` |
...
| <a id="s-a874738d53"></a>`operational` | <a id="s-9db75d79e6"></a>`{"kind":"application-error"}` | <a id="s-228e2b61e2"></a>`1` | <a id="s-cc7127df5b"></a>`human: empty; json: http-api-contracts.ErrorResponse` | <a id="s-6ab71e83d7"></a>`human: noncontractual-diagnostic; json: empty` |
