...
|---|---|---|---|
| <a id="s-8e6851d93a"></a>`selector`<br>`selector` | required positional; 1 value | text | not recorded |
| <a id="s-7a43b24679"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
