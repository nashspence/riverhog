...
<!-- contract-element: cli:piggity:piggity-archive-copy-cancel:997b1a5574 -->
...
- <a id="s-ff41632399"></a>Extra arguments at this parser: rejected.
- <a id="s-9a07ea0f83"></a>Options after positional arguments at this parser: parsed as options.
- <a id="s-86ec16db47"></a>Unknown options at this parser: rejected.
...
|---|---|---|---|
| <a id="s-a4a7803ca4"></a>`selector`<br>`selector` | required positional; 1 value | text | not recorded<br>Env: `null` |
| <a id="s-4dedd6e3c3"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false`<br>Env: `null` |
...
|---|---|---|
| [CLI parameter --json](#s-4dedd6e3c3) | `cardinality · values-per-occurrence · fixed` | maximum=0; minimum=0; source_constraint={"field":"is_flag"} |
| [CLI parameter selector](#s-a4a7803ca4) | `cardinality · values-per-occurrence · fixed` | maximum=1; minimum=1; source_constraint={"field":"nargs"} |
...
- <a id="pa-734c0c7791"></a>[compatibility/cli/v1](../../release/compatibility-guarantees/compatibility-cli.md#p-48a89776de)
- <a id="pa-6b0c1f909e"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
- **Command callback:** [reference/riverhog/applications/piggity/src/piggity/main.py::archive\_copy\_cancel\_cmd](../../../../../../reference/riverhog/applications/piggity/src/piggity/main.py#L3062)

### Machine authority

- `/external_contract/cli/piggity/commands/archive/commands/copy/commands/cancel/allow_extra_args`
- `/external_contract/cli/piggity/commands/archive/commands/copy/commands/cancel/allow_interspersed_args`
- `/external_contract/cli/piggity/commands/archive/commands/copy/commands/cancel/ignore_unknown_options`
