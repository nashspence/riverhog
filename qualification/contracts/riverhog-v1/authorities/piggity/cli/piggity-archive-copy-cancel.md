...
|---|---|---|---|
| <a id="s-a4a7803ca4"></a>`selector`<br>`selector` | required positional; 1 value | text | not recorded |
| <a id="s-4dedd6e3c3"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
