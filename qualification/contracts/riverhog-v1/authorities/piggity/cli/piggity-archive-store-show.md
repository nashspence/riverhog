...
|---|---|---|---|
| <a id="s-ca052d74b2"></a>`store`<br>`store` | required positional; 1 value | text | not recorded |
| <a id="s-dc26e9779c"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
