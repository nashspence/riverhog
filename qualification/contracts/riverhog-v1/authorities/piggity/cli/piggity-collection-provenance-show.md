...
|---|---|---|---|
| <a id="s-264a1748ef"></a>`collection_id`<br>`collection_id` | required positional; 1 value | integer | not recorded |
| <a id="s-157533c3ca"></a>`path`<br>`path` | required positional; 1 value | text | not recorded |
| <a id="s-118774fada"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
...
- <a id="pa-742fdd1081"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de)
- <a id="pa-0a778a9955"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
...
- **Command callback:** [reference/riverhog/applications/piggity/src/piggity/main.py::provenance_show_cmd](../../../../../../reference/riverhog/applications/piggity/src/piggity/main.py#L2623)
