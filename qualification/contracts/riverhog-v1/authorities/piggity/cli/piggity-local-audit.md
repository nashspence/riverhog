...
- <a id="s-de923e4a3368"></a>Parser name: `audit`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-2df9614c583b"></a>`json_mode` | TyperOption | no | {'class': 'typer._click.types.BoolParamType', 'name': 'boolean'} | --json |
...
|---|---|---|
| [CLI parameter --json](#s-2df9614c583b) | `cardinality · values-per-occurrence · fixed` | shared above |

## Governing policies

- <a id="pa-874a4ccfa0d6"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-6e1fd872128c"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
