...
- <a id="s-d4846c39082b"></a>Parser name: `remove`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-0b8d9cb7e8e8"></a>`collection_id` | TyperArgument | yes | {'class': 'typer._click.types.IntParamType', 'name': 'integer'} | collection_id |
| <a id="s-64e6ad6b9dd0"></a>`json_mode` | TyperOption | no | {'class': 'typer._click.types.BoolParamType', 'name': 'boolean'} | --json |
...
|---|---|---|
| [CLI parameter collection_id](#s-0b8d9cb7e8e8) | `cardinality · values-per-occurrence · fixed` | shared above |
| [CLI parameter --json](#s-64e6ad6b9dd0) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-4cc82e1b8372"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-3ddb2a627234"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
