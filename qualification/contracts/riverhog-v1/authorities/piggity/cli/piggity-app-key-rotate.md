...
|---|---|---|---|
| <a id="s-667bdb79a0"></a>`app_name`<br>`app_name` | required positional; 1 value | text | not recorded |
| <a id="s-fa35dffec2"></a>`key_id`<br>`key_id` | required positional; 1 value | text | not recorded |
| <a id="s-6529995c44"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
...
- <a id="pa-3a0600115f"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de)
- <a id="pa-84298f2d16"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
