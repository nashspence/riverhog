...
<!-- contract-element: cli:piggity:piggity-collection-tag-add:17a519bf10 -->
...
- <a id="s-85eaeeb714"></a>Extra arguments at this parser: rejected.
- <a id="s-7e9d48cbd4"></a>Options after positional arguments at this parser: parsed as options.
- <a id="s-69038e6218"></a>Unknown options at this parser: rejected.
...
|---|---|---|---|
| <a id="s-89f773ed42"></a>`collection_id`<br>`collection_id` | required positional; 1 value | integer | not recorded<br>Env: `null` |
| <a id="s-59325e9744"></a>`tag`<br>`tag` | required positional; 1 value | text | not recorded<br>Env: `null` |
| <a id="s-487a06b9dc"></a>`revision`<br>`--revision` | optional option; 1 value | integer range; minimum=`1` (inclusive); outside range: reject | not recorded<br>Env: `null` |
| <a id="s-a62b2b4357"></a>`tag_set_identity`<br>`--tag-set-identity` | optional option; 1 value | text | not recorded<br>Env: `null` |
| <a id="s-5f64c2a2b6"></a>`operation_id`<br>`--operation-id` | optional option; 1 value | text | not recorded<br>Env: `null` |
| <a id="s-0fed947d41"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false`<br>Env: `null` |
...
- <a id="pa-6aebf9da13"></a>[compatibility/cli/v1](../../release/compatibility-guarantees/compatibility-cli.md#p-48a89776de)
- <a id="pa-fca0a084de"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
- **Command callback:** [reference/riverhog/applications/piggity/src/piggity/main.py::collection\_tag\_add\_cmd](../../../../../../reference/riverhog/applications/piggity/src/piggity/main.py#L1057)

### Machine authority

- `/external_contract/cli/piggity/commands/collection/commands/tag/commands/add/allow_extra_args`
- `/external_contract/cli/piggity/commands/collection/commands/tag/commands/add/allow_interspersed_args`
- `/external_contract/cli/piggity/commands/collection/commands/tag/commands/add/ignore_unknown_options`
