...
- <a id="s-0bb25d44e519"></a>Parser name: `cancel`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-582579864a70"></a>`collection_id` | TyperArgument | yes | {'class': 'typer._click.types.IntParamType', 'name': 'integer'} | collection_id |
| <a id="s-d35c5ac384b9"></a>`json_mode` | TyperOption | no | {'class': 'typer._click.types.BoolParamType', 'name': 'boolean'} | --json |
...
|---|---|---|
| [CLI parameter collection_id](#s-582579864a70) | `cardinality · values-per-occurrence · fixed` | shared above |
| [CLI parameter --json](#s-d35c5ac384b9) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-456c6b89fa19"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-ab08c77be14a"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
