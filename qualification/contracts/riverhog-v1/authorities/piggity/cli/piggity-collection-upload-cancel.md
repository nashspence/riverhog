...
|---|---|---|---|
| <a id="s-582579864a"></a>`collection_id`<br>`collection_id` | required positional; 1 value | integer | not recorded |
| <a id="s-d35c5ac384"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
