...
|---|---|---|---|
| <a id="s-c68e7235a4"></a>`collection_id`<br>`collection_id` | required positional; 1 value | integer | not recorded<br>Env: `null` |
| <a id="s-d3124c5e01"></a>`wait`<br>`--wait`, alternate: `--no-wait` | optional flag; 0 values | boolean | `true`<br>Env: `null` |
| <a id="s-68fb245f82"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false`<br>Env: `null` |
...
- <a id="pa-cd0b0ce8ba"></a>[compatibility/cli/v1](../../release/compatibility-guarantees/compatibility-cli.md#p-48a89776de)
- <a id="pa-e963c55740"></a>[extent-rule/schema-bound/v1](../../extent-contract/extent/extent-rule-schema-bound.md#p-c0db822fc0)
...
- **Command callback:** [reference/riverhog/applications/piggity/src/piggity/main.py::provenance\_verify\_cmd](../../../../../../reference/riverhog/applications/piggity/src/piggity/main.py#L2706)
