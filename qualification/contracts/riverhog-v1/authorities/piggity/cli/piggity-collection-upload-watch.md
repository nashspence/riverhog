...
- <a id="s-3f50299b4160"></a>Parser name: `watch`

### Parameters

| Name | Kind | Required | Type | Options |
|---|---|---:|---|---|
| <a id="s-2d6558a87d0f"></a>`collection_id` | TyperArgument | yes | {'class': 'typer._click.types.IntParamType', 'name': 'integer'} | collection_id |
| <a id="s-514e76b0295c"></a>`json_mode` | TyperOption | no | {'class': 'typer._click.types.BoolParamType', 'name': 'boolean'} | --json |
...
|---|---|---|
| [CLI parameter collection_id](#s-2d6558a87d0f) | `cardinality · values-per-occurrence · fixed` | shared above |
| [CLI parameter --json](#s-514e76b0295c) | `cardinality · values-per-occurrence · fixed` | shared above |
...
- <a id="pa-a84efca52074"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de7f)
- <a id="pa-0437354e0bca"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc034)
