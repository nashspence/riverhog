...
|---|---|---|---|
| <a id="s-157365010e"></a>`collection_id`<br>`collection_id` | required positional; 1 value | integer | not recorded |
| <a id="s-f117275074"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
