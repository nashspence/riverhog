...
|---|---|---|---|
| <a id="s-6d86b9c512"></a>`name`<br>`name` | required positional; 1 value | text | not recorded |
| <a id="s-85ac36453b"></a>`json_mode`<br>`--json` | optional flag; 0 values | boolean | `false` |
...
- <a id="pa-5bde38f73e"></a>[compatibility/cli/v1](../../../policies/index.md#p-48a89776de)
- <a id="pa-c9e3ba5a59"></a>[extent-rule/schema-bound/v1](../../../policies/index.md#p-c0db822fc0)
