...
_CLI_RESULT_CONTRACT = {
    ...
    "identity_prefix": "riverhog-storage-adapter-aws-cli-result",
    "default_profile": "runtime",
    "profiles": {
        "runtime": {
            "id": "riverhog-storage-adapter-aws-cli-runtime/v1",
    ...
    "output_authorities": {},
    "version_distribution": "riverhog-storage-adapter-aws",
}
