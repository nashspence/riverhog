...
_CLI_RESULT_CONTRACT = {
    ...
    "identity_prefix": "stove0-nvenc-av1-opus-target-cli-result",
    "default_profile": "runtime",
    "profiles": {
        "runtime": {
            "id": "stove0-nvenc-av1-opus-target-cli-runtime/v1",
    ...
    "output_authorities": {},
    "version_distribution": "stove0-nvenc-av1-opus-target",
}
