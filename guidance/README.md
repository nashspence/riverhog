...
- [`tests/unit/test_operation_qualification.py::test_operation_audiences_distinguish_commands_wires_and_protocols`](../tests/unit/test_operation_qualification.py) — Checks representative current audience classifications. The wider design preference is an
inference for maintainer review.
