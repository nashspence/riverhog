...
from a_stove0_opus_target.target import OpusTargetService

TARGET_SERVICE = "a-stove0-opus-target"
...
_CLI_RESULT_CONTRACT = {
    ...
    "identity_prefix": "a-stove0-opus-target-cli-result",
    "default_profile": "runtime",
    "profiles": {
        "runtime": {
            "id": "a-stove0-opus-target-cli-runtime/v1",
    ...
    "output_authorities": {},
    "version_distribution": "a-stove0-opus-target",
}


def _parser() -> argparse.ArgumentParser:
    prefix = "A_STOVE0_OPUS_TARGET"
...
def target_main(argv: Sequence[str] | None = None) -> int:
    ...
    target = OpusTargetService(
        state_root=Path(os.getenv(f"{prefix}_STATE_ROOT", "/var/lib/a-stove0-opus-target")),
        workspace_root=Path(os.getenv(f"{prefix}_WORKSPACE", "/run/a-stove0-opus-target")),
