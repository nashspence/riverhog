...
from review0_sampler_client.client import ReviewSamplerClient
...
SAMPLER_CONFORMANCE_RESULT: Literal["review0-sampler-conformance-result/v1"] = (
    "review0-sampler-conformance-result/v1"
)
...
_CLI_RESULT_CONTRACT = {
    ...
    "profiles": {
        "machine-report": {
            "id": "review0-sampler-conformance-cli/v1",
...
class SamplerConformanceResult(_SamplerConformanceModel):
    format: Literal["review0-sampler-conformance-result/v1"] = SAMPLER_CONFORMANCE_RESULT
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="review0-sampler-conformance",
