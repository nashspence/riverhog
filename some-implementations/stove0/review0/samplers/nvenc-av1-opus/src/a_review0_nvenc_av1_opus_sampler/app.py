...
from a_review0_nvenc_av1_opus_sampler.sampler import NvencAv1OpusReviewSampler

SERVICE = "a-review0-nvenc-av1-opus-sampler"
...
_CLI_RESULT_CONTRACT = {
    ...
    "profiles": {
        "runtime": {
            "id": "a-review0-nvenc-av1-opus-sampler-cli-runtime/v1",
    ...
    "output_authorities": {},
    "version_distribution": "a-review0-nvenc-av1-opus-sampler",
}


def _parser() -> argparse.ArgumentParser:
    prefix = "A_REVIEW0_NVENC_AV1_OPUS_SAMPLER"
