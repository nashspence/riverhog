...
from review0_target_contracts import REVIEW_RCLONE_DELIVER_OPERATION
...
EFFECT_OPTIONS = review_options_schema(
    "a-review0-rclone-target-options/v1",
...
class RcloneReviewDestination:
    ...
    def commit(
        ...
        *,
        ...
        return {
            "format": "review0-rclone-receipt/v1",
        ...
        *,
        ...
        manifest_path.write_bytes(
            canonical_json_bytes(
                {
                    "format": "review0-delivery-manifest/v1",
