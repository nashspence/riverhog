...
STOVE0_CORE = (
    REPO_ROOT / "some-implementations" / "stove0" / "application" / "server" / "src" / "stove0_core"
)
STOVE0_SERVER = REPO_ROOT / "some-implementations" / "stove0" / "application" / "server" / "src"
PROTOCOL_ROOT = REPO_ROOT / "some-implementations" / "stove0" / "packages" / "protocol" / "src"
RIVERHOG_RUNTIME_ROOTS = (
    REPO_ROOT / "riverhog" / "src",
    REPO_ROOT / "packages" / "riverhog-protocol" / "src",
)
OBSERVER_PROTOCOL_ROOT = (
    REPO_ROOT / "some-implementations" / "stove0" / "packages" / "observer-protocol" / "src"
)
OBSERVER_ROOT = (
    REPO_ROOT / "some-implementations" / "stove0" / "packages" / "observer-support" / "src"
)
TARGET_PROTOCOL_ROOT = (
    REPO_ROOT / "some-implementations" / "stove0" / "packages" / "target-protocol" / "src"
)
TARGET_ROOT = REPO_ROOT / "some-implementations" / "stove0" / "packages" / "target-support" / "src"
...
MEDIA_ARCHIVE_TARGET_SUPPORT_ROOT = (
    REPO_ROOT / "some-implementations" / "stove0" / "targets" / "media-archive" / "support" / "src"
)
REVIEW_TARGET_CONTRACT_ROOT = (
    REPO_ROOT / "some-implementations" / "stove0" / "review0" / "contracts" / "src"
)
REVIEW_PLANNING_ROOT = (
    REPO_ROOT / "some-implementations" / "stove0" / "review0" / "planning" / "src"
)
CALLER_ROOTS = (
    REPO_ROOT / "some-implementations" / "stove0" / "packages" / "observer-client" / "src",
    REPO_ROOT / "some-implementations" / "stove0" / "packages" / "target-client" / "src",
    REPO_ROOT / "some-implementations" / "stove0" / "review0" / "sampler" / "client" / "src",
)
IMPLEMENTATION_ROOT = REPO_ROOT / "some-implementations" / "stove0"
MAINTAINED_TARGETS = (
    IMPLEMENTATION_ROOT
    / "targets"
    / "opus"
...
def test_maintained_components_do_not_import_product_internals() -> None:
    imports = {
        imported
        for component_kind in ("observers", "targets", "review0")
