...
def _discover_mount_points():
    if sys.platform == "linux":
        from a_gogurt_linux_volume import MOUNTED_VOLUME_PROVIDER_BINDING
    elif sys.platform == "darwin":
        from a_gogurt_macos_volume import MOUNTED_VOLUME_PROVIDER_BINDING
    elif sys.platform == "win32":
        from a_gogurt_windows_volume import MOUNTED_VOLUME_PROVIDER_BINDING
