...
import pytest
from a_gogurt_linux_volume import (
    MOUNTED_VOLUME_PROVIDER_BINDING as LINUX_MOUNTED_VOLUME_PROVIDER,
)
from a_gogurt_linux_volume import linux_mount_points
from a_gogurt_macos_volume import (
    MOUNTED_VOLUME_PROVIDER_BINDING as MACOS_MOUNTED_VOLUME_PROVIDER,
)
from a_gogurt_macos_volume import macos_mount_points
from a_gogurt_windows_volume import (
    MOUNTED_VOLUME_PROVIDER_BINDING as WINDOWS_MOUNTED_VOLUME_PROVIDER,
)
from a_gogurt_windows_volume import windows_mount_points
...
def test_supplied_provider_identities_seal_the_path_route_line_representation() -> None:
    assert {
