...
def _native_listener_adapter() -> ListenerAdapter:
    if sys.platform == "linux":
        from a_gogurt_linux_listener import listener_adapter
    elif sys.platform == "darwin":
        from a_gogurt_macos_listener import listener_adapter
    elif sys.platform == "win32":
        from a_gogurt_windows_listener import listener_adapter
