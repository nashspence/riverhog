...
from a_riverhog_event_relay.relay import EventRelay, load_config, summarize_config
from a_riverhog_event_relay.schema import state_schema
...
_CLI_RESULT_CONTRACT = {
    ...
    "profiles": {
        "state-human-json": {
            "id": "a-riverhog-event-relay-cli-state-human-json/v1",
        ...
        "relay-runtime": {
            "id": "a-riverhog-event-relay-cli-relay-runtime/v1",
            ...
            "success": [
                {
                    ...
                    "exit_status": 0,
                    "stdout": {"all": "a-riverhog-event-relay-configuration-summary/v1"},
    ...
    "version_distribution": "a-riverhog-event-relay",
}
...
def parser() -> argparse.ArgumentParser:
    ...
    result.add_argument(
        "--version",
        action="version",
        version=importlib.metadata.version("a-riverhog-event-relay"),
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "state":
        ...
        if args.json:
            ...
            print(
                f"a-riverhog-event-relay state: {payload['condition']} "
