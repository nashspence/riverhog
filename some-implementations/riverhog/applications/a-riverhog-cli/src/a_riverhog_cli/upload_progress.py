...
from a_riverhog_cli.cli_support import plain_output_requested
from a_riverhog_cli.output import ATTENTION_STYLE, ENTITY_ID_STYLE, FIELD_STYLE
...
def _rich_progress_available() -> bool:
    return (
        ...
        and not plain_output_requested("A_RIVERHOG_CLI_PLAIN")
    )
