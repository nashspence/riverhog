"""Executable ASGI service for the Riverhog filesystem store."""
...
SERVICE = "a-riverhog-filesystem-store"
_PREFIX = "A_RIVERHOG_FILESYSTEM_STORE_"
...
_CLI_RESULT_CONTRACT = {
    ...
    "profiles": {
        "runtime": {
            "id": "a-riverhog-filesystem-store-cli-runtime/v1",
    ...
    "output_authorities": {},
    "version_distribution": "a-riverhog-filesystem-store",
}
