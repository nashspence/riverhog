...
COMMAND = "a-riverhog-filesystem-store-materialize"
...
_CLI_RESULT_CONTRACT = {
    ...
    "profiles": {
        "human-json": {
            "id": "a-riverhog-filesystem-store-materialize-cli/v1",
...
def _version() -> str:
    try:
        return importlib.metadata.version("a-riverhog-filesystem-store")
